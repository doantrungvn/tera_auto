            ...
            <td colspan="2">
                <div style="height:100%">
                    ...
                    <div class="pull-right" style="height:100%;vertical-align: middle;">
                        ...
                        <input type="hidden" name="commonObjectAttributes[${itemValue.itemSeqNo}].commonObjectAttributeId" value="${itemValue.externalObjectAttributeId}"/>
                        <input type="hidden" name="commonObjectAttributes[${itemValue.itemSeqNo}].commonObjectAttributeName" value="${itemValue.externalObjectAttributeName}"/>
                        <input type="hidden" name="commonObjectAttributes[${itemValue.itemSeqNo}].parentCommonObjectAttributeId" value="${itemValue.parentExternalObjectAttributeId}"/>
                        ...
                        <qp:autocomplete name = "commonObjectAttributes[${itemValue.itemSeqNo}].objectDefinitionId" optionLabel="optionLabel" selectSqlId="getAutocompleteGetExternalObject" optionValue="optionValue" 
                            arg01="${sessionScope.CURRENT_PROJECT.projectId}" arg02="20" arg03="" mustMatch="true" onChangeEvent="onChangeExternalObject" value="${itemValue.objectDefinitionId }" displayValue="${itemValue.externalObjectAttributeName}"></qp:autocomplete>
                    	<input type="hidden" name="commonObjectAttributes[${itemValue.itemSeqNo}].moduleId" value="${itemValue.moduleId}"/>
                    </div>
                </div>
            </td>
            <td>
                <input type="text" name="commonObjectAttributes[${itemValue.itemSeqNo}].commonObjectAttributeCode" class="form-control qp-input-text qp-convention-code-row" maxlength="50" value="${itemValue.externalObjectAttributeCode}"/>
            </td>
            <td>
        ...
        <c:choose>
                    ...
                    <td colspan="2">
                        <div style="height:100%">
                            ...
                            <div class="pull-right" style="height:100%;vertical-align: middle;">
                                ...
                                <input type="hidden" name="commonObjectAttributes[${itemValue.itemSeqNo}].parentCommonObjectAttributeId" value="${itemValue.parentExternalObjectAttributeId}"/>
                                <input type="hidden" name="commonObjectAttributes[${itemValue.itemSeqNo}].saveFlg" value="true"/>
                                <input type="text" name="commonObjectAttributes[${itemValue.itemSeqNo}].commonObjectAttributeName" class="form-control qp-input-text qp-convention-name-row" maxlength="200" value="${itemValue.externalObjectAttributeName}"/>
                            </div>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="input-group">
                            ...
                            <select name="commonObjectAttributes[${itemValue.itemSeqNo}].dataType" class="form-control qp-input-select pull-left" onchange="objectTypeChange(this);" value="${itemValue.dataType}">
                                <option value=""><qp:message code="sc.sys.0030"></qp:message></option>
                                <c:forEach var="item" items="${CL_EX_DATATYPE}">
            ...
            <c:otherwise>
                <tr data-ar-rgroup="${itemValue.groupId}" class="ar-dataRow" data-ar-templateid="tbl_attribute_list_define-common-object-columm-template" data-ar-rindex="${itemValue.itemSeqNo }" data-ar-rgroupindex="${itemValue.tableIndex }" >
                    ...
                    <td>
                        <input type="hidden" name="commonObjectAttributes[${itemValue.itemSeqNo}].commonObjectAttributeCode" value="${itemValue.externalObjectAttributeCode}"/>
