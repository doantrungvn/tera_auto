<tiles:insertDefinition name="layouts">
    ...
    <tiles:putAttribute name="breadcrumb">
         ...
         <li><span><qp:message code="sc.subareadesign.0019"/></span></li>
    </tiles:putAttribute>
    
    <tiles:putAttribute name="header-link">
        <qp:authorization permission="subjectareaSearch">
        	<span class="qp-link-header-icon glyphicon glyphicon-search"></span>
            <a href="${pageContext.request.contextPath}/subjectarea/search"><qp:message code="sc.subareadesign.0001"/></a>
        </qp:authorization>
    </tiles:putAttribute>
    ...
    <tiles:putAttribute name="body">
        ...
        <script id="tmp_list_table-template" type="text/template">
            <tr>
                <td class="qp-output-fixlength tableIndex">
                    <input type="hidden" name="tableLst[].tableCode">
                </td>
                <td style="vertical-align:top">
                    <div class="input-group" style="width:100%">
                    <input type="text" name="tableLst[].tableDesignIdAutocomplete" id="tableLst[].tableDesignIdAutocompleteId" mustMatch="true"
                     class="form-control qp-input-autocomplete" optionValue="optionValue" optionLabel="optionLabel" maxlength="200"
                     selectsqlid="getAllTableDesignByProjectId" minLength = "0" onChangeEvent="changeTableCodeLabel"
                     arg02="${subjectAreaForm.projectId}" placeholder='<qp:message code="sc.sys.0034"></qp:message>' />
        ...
        <form:form method="post" modelAttribute="subjectAreaForm" action="${pageContext.request.contextPath}/subjectarea/modify">
        	...
        	<c:if test="${notExistFlg ne 1 }">
	                ...
	                <div class="panel-body">
	                    <table class="table table-bordered qp-table-form">
	                        ...
	                        <tr>
	                            ...
	                            <td>
	                                <form:input type="text" cssClass="form-control qp-input-text qp-convention-name-row" path="areaName" maxlength="200"/>
	                            </td>
	                            <th>
	                        ...
	                        <tr>
	                            <th><qp:message code="sc.subareadesign.0012"/></th>
	                            <td colspan="3">
	                                        ...
	                                        <c:forEach var="position" items="${subjectAreaForm.positionLst }" varStatus="status">
	                                            <c:if test="${subjectAreaForm.itemSeqNo == position.itemSeqNo}">
	                                                <tr class="trChange">
	                                                    ...
	                                                    <td><qp:formatText value="${position.areaName}"></qp:formatText></td>
	                                                    <td><qp:formatText value="${position.areaCode}"></qp:formatText></td>
	                                                    <td>
		                                                    <c:if test="${position.defaultFlg eq 1}">
		                                                      	<span class="glyphicon glyphicon-ok"></span>
		                                                    </c:if>
	                                                    </td>
														<td class="sortable">
															<a style="margin-top: 3px; cursor: move;" class="glyphicon glyphicon-sort" title="Move" title="Move" href="javascript:void(0)"></a>
														</td>
	                                                </tr>
	                                            </c:if>
	                                            <c:if test="${subjectAreaForm.itemSeqNo != position.itemSeqNo}">
	                                                <tr>
	                                                    <td class="qp-output-fixlength tableIndex">
	                                                            ...
	                                                            <input type="hidden" name="positionLst[${status.index}].areaName" value="${position.areaName}">
	                                                            <input type="hidden" name="positionLst[${status.index}].areaCode" value="${position.areaCode}">
	                                                            <input type="hidden" name="positionLst[${status.index}].areaCode" value="${position.defaultFlg}">
	                                                    </td>
	                                                    <td><qp:formatText value="${position.areaName}"></qp:formatText></td>
	                                                    <td><qp:formatText value="${position.areaCode}"></qp:formatText></td>
	                                                    <td>
	            ...
	            <div class="panel panel-default qp-div-select">
	                ...
	                <div class="panel-body">
	                    <table class="table table-bordered qp-table-list" id="tmp_list_table">
	                        <colgroup>
	                            <col />
	                            <col />
	                            <col />
	                                ...
	                                <tr>
	                                    ...
	                                    <td>
	                                            <qp:autocomplete optionValue="optionValue" 
	                                                ...
	                                                displayValue="${table.tableName}"
	                                                optionLabel="optionLabel" mustMatch="true"
	                                                onChangeEvent="changeTableCodeLabel" maxlength="200">
	                                            </qp:autocomplete>
	                                        </td>
	            ...
	            <div class="panel panel-default qp-div-select">
	                ...
	                <div class="panel-body">
	                    <table class="table table-bordered qp-table-list" id="tmp_list_keyword">
	                        <colgroup>
	                            <col />
	                            <col />
	                        </colgroup>
	            ...
	            <div class="qp-div-action">
	                <qp:authorization permission="subjectareaModify">
	                    ...
	                    <form:hidden path="projectIdAutocomplete" value="${subjectAreaForm.projectName}"/>
	                    <form:hidden path="itemSeqNo"/>
	                    <form:hidden path="updatedDate" />
	                    <form:hidden path="updatedBy" />
	                    <button type="submit" class="btn btn-md qp-button qp-dialog-confirm"><qp:message code="sc.sys.0031"></qp:message></button>
	                </qp:authorization>
	            </div>
            </c:if>
        </form:form>
