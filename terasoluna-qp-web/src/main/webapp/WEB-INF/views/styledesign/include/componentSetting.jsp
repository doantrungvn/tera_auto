		    		...
		    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>  	     
		      		<div class="modal-body">
		      			<ul class="nav nav-tabs">
							<li class="active">
								<a href="#componentSetting-properties" data-toggle="tab"><qp:message code="sc.screendesign.0064"></qp:message></a>
							</li>
							<li><a href="#componentSetting-style" data-toggle="tab"><qp:message code="sc.screendesign.0339"/></a></li>
						</ul>
						<div class="tab-content" style="min-height: 450px;width: 570px;">
							<div id="componentSetting-properties" class="tab-pane active">
										...
										<script>
						       			...
						       			<table class="table table-bordered qp-table-form">
											...
											<tr>
												<th>Convert to</th>																							
												<td>													
													<label><input class="qp-input-radio-margin qp-input-radio" onclick="isLink(this)" value="1" type="radio" name="convertTo" checked="checked" /> Text</label>
													<label><input class="qp-input-radio-margin qp-input-radio" onclick="isLink(this)" value="2" type="radio" name="convertTo" /> Link</label>													
												</td>
											</tr>
											<tr name="isLink">
												...
												<td>
													<qp:autocomplete 
					                                        ...
					                                        onChangeEvent="changeModule" onSelectEvent="selectModuleNameComponentSetting"
							...
							<div id="componentSetting-style" class="tab-pane">
									<div class="panel panel-default  qp-div-information">
										<div class="panel-heading">
											...
											<table class="table table-bordered qp-table-form">
												...
												<tr>
													...
													<td>
														<div class="input-group qp-input-pickcolor colorpicker-element">
															<span class="input-group-addon"> <i style="background-color: rgb(65, 150, 65);"></i></span>
															<input name="color" class="form-control" type="text" value="#419641">
														</div>
													</td>
												</tr>
												<tr>
												...
												<tr class="hover">
													...
													<td>
														<div class="input-group qp-input-pickcolor colorpicker-element">
															<span class="input-group-addon"> <i style="background-color: rgb(65, 150, 65);"></i></span>
															<input name="hoverStyle=color" class="form-control" type="text" value="#419641">
														</div>
													</td>
												</tr>
												<tr class="hover">
												...
												<tr class="hover">
													...
													<td>
														<div class="input-group qp-input-pickcolor colorpicker-element">
															<span class="input-group-addon"> <i style="background-color: rgb(65, 150, 65);"></i></span>
															<input class="form-control" name="hoverStyle=background-color" type="text" value="#419641">
														</div>
													</td>
												</tr>
											</table>
			      		...
			      		<div class="modal-footer">
			        		<button type="button" class="btn qp-button-client" onclick="deleteDialogComponentSetting(this)"><qp:message code="sc.sys.0014"></qp:message></button>
			        		<button type="button" class="btn qp-button-client" onclick="saveDialogComponentSetting(this)"><qp:message code="sc.sys.0054"></qp:message></button>
			      		</div>
		   	 		</div>
		  		</div>
			</div>