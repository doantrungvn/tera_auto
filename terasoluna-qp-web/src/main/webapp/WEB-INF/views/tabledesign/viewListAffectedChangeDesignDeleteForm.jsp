		...
		<form:form method="post" action="${pageContext.request.contextPath}/tabledesign/delete" modelAttribute="tableDesignForm">
			...
			<div class="qp-div-action">
				<qp:authorization permission="tabledesignModify">
					...
					<a type="submit" class="btn qp-button qp-link-button qp-link-button" href="${pageContext.request.contextPath}/tabledesign/view?tableDesignId=${tableDesignForm.tableDesignId}&mode=1&showImpactFlag=${tableDesignForm.showImpactFlag}">
							<qp:message code="sc.sys.0049" />
					</a>				
			...
			<div class="panel panel-default qp-div-select">
				<div class="panel-heading">
					<span class="glyphicon  qp-heading-icon" aria-hidden="true">&nbsp;</span>
					<span class="pq-heading-text">SQL design list</span>
				</div>
				<div class="panel-body">
					<table id="tbl_list_Subject"
						class="table table-bordered qp-table-list-none-action" data-ar-callback="callback">
