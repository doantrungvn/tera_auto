<tiles:insertDefinition name="layouts">
    ...
    <tiles:putAttribute name="breadcrumb">
         ...
         <li><span><qp:message code="sc.decisiontable.0020"/></span></li>
    </tiles:putAttribute>
    ...
    <tiles:putAttribute name="body">
        ...
        <form:form method="post" action="${pageContext.request.contextPath}/decisiontable/modifyConfirm" modelAttribute="decisionTableForm">
            <form:errors path="*" cssClass="alert qp-error" delimiter="<br/>" element="div" cssStyle="" />
            <c:if test="${ isNotExist ne 1}">
                ...
                <div class="panel panel-default qp-div-information">
                    <div class="panel-heading">
                        <span class="glyphicon  qp-heading-icon" aria-hidden="true">&nbsp;</span> <span class="pq-heading-text"><qp:message code="sc.decisiontable.0007" /></span>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered qp-table-form">
                            ...
                            <tr>
                                <th><form:label path="decisionTbName">
                                        <qp:message code="sc.decisiontable.0005" />&nbsp;<span class="qp-required-field"><qp:message code="sc.sys.0029" /></span>
                                    </form:label></th>
                                <td><form:input type="text" cssClass="form-control qp-input-text" path="decisionTbName" maxlength="200" autofocus="true" /></td>
                                <th><form:label path="decisionTbCode">
                                        <qp:message code="sc.decisiontable.0006" />&nbsp;<span class="qp-required-field"><qp:message code="sc.sys.0029" /></span>
                                    </form:label></th>
                                <td><form:input type="text" cssClass="form-control qp-input-text" path="decisionTbCode" maxlength="50" /></td>
                            </tr>
                            <tr>
                                <th><form:label path="moduleName">
                                        <form:hidden path="moduleName" />
                                        <qp:message code="sc.module.0007" />
                                    </form:label></th>
                                <td><qp:formatText value="${decisionTableForm.moduleName}" /></td>
                                <th><form:label path="designStatus">
                                        <qp:message code="sc.sys.0055"></qp:message>
                                    </form:label></th>
                                <td><form:hidden path="designStatus" />
                ...
                <div id="tabsDecision">
                    ...
                    <div class="tab-content">
                        <div id="tabsDecision-1" class="tab-pane active" style="height: auto; min-height: 300px;"></div>

                        <div id="tabsDecision-2" class="tab-pane" style="height: auto;">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div>
                                        <table class="table table-bordered qp-table-list" id="tbl_input_list_result" data-ar-dataClass="ar-dataRow" data-ar-callback="$.qp.decisiontable.formCallback">
                                            <colgroup>
                                                <col />
                                                <col width="450px" />
                                                <col width="25%" />
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${inputBean.dataType == '16' && inputBean.objectFlg}">
                                                            <tr data-ar-rgroup="${inputBean.groupId}" class="ar-dataRow" data-ar-templateid="tbl_inputbean_list_define-common-object-template" data-ar-rindex="${inputBean.itemSequenceNo }" data-ar-rgroupindex="${inputBean.tableIndex }">
                                                                ...
                                                                <td><form:input path="inputLst[${status.index}].decisionInputBeanCode" class="form-control qp-input-text" maxlength="50" onfocus="markValue(this)" value="" onchange="setBeanCode(this);"/></td>
                                                                <td>
                                                                    <div>
                                                                        <form:hidden path="inputLst[${status.index}].dataType" />
                                                                        <form:select cssClass="form-control qp-input-select" path="inputLst[${status.index}].dataType" onfocus="markValue(this);" oldvalue="${inputBean.dataType}" onchange="changeDataType(this);">
                                                                            <form:option value="">
                                                        ...
                                                        <c:otherwise>
                                                            <tr data-ar-rgroup="${inputBean.groupId}" class="ar-dataRow" data-ar-templateid="tbl_inputbean_list_define-template" data-ar-rindex="${inputBean.itemSequenceNo }" data-ar-rgroupindex="${inputBean.tableIndex }">
                                                                <td colspan="2" style="width: 492px">
                                                                    <div style="height: 100%">
                                                                        ...
                                                                        <div class="pull-right" style="height: 100%; vertical-align: middle;">
                                                                            ...
                                                                            <form:hidden path="inputLst[${status.index}].groupId" class="ar-groupId"/>
                                                                            <form:hidden path="inputLst[${status.index}].tableIndex" class="ar-groupIndex" />
                                                                            <form:input path="inputLst[${status.index}].decisionInputBeanName" class="form-control qp-input-text" maxlength="200" onfocus="markValue(this)" onchange="setBeanName(this);"/>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td><form:input path="inputLst[${status.index}].decisionInputBeanCode" class="form-control qp-input-text" maxlength="50" onfocus="markValue(this);" value="" onchange="setBeanCode(this);"/></td>
                                                                <td>
                                                                    <div>
                                                                        <form:select cssClass="form-control qp-input-select" path="inputLst[${status.index}].dataType" onfocus="markValue(this);" onchange="changeDataType(this);">
                                                                            <form:option value="">
                                                                                <qp:message code="sc.sys.0030"></qp:message>
                                                                            </form:option>
                                                                            <form:options items="${CL_QP_DATATYPE}" />
                                        ...
                                        <div class="qp-div-action-table">
                                            <a type="button" class="btn btn-default btn-xs glyphicon glyphicon-plus qp-button-action" onclick="$.qp.ar.addRow({link:this,tableId:'tbl_input_list_result',templateId:'tbl_input_list_result-template',templateDate:{groupId:''}});"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="tabsDecision-3" class="tab-pane" style="height: auto;">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div>
                                        <table class="table table-bordered qp-table-list" id="tbl_output_list_result" data-ar-dataClass="ar-dataRow" data-ar-callback="$.qp.decisiontable.formCallback">
                                            <colgroup>
                                                <col />
                                                <col width="450px" />
                                                <col width="25%" />
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${outputBean.dataType == '16' && outputBean.objectFlg}">
                                                            <tr data-ar-rgroup="${outputBean.groupId}" class="ar-dataRow" data-ar-templateid="tbl_outputbean_list_define-common-object-template" data-ar-rindex="${outputBean.itemSequenceNo }" data-ar-rgroupindex="${outputBean.tableIndex }">
                                                                ...
                                                                <td><form:input path="outputLst[${status.index}].decisionOutputBeanCode" class="form-control qp-input-text" maxlength="50" onfocus="markValue(this);" value="" onchange="setBeanCode(this);"/></td>
                                                                <td>
                                                                    <div>
                                                                        <form:hidden path="outputLst[${status.index}].dataType" />
                                                                        <form:select cssClass="form-control qp-input-select" path="outputLst[${status.index}].dataType" onfocus="markValue(this);" oldvalue="${outputBean.dataType}" onchange="changeDataType(this);">
                                                                            <form:option value="">
                                                                                <qp:message code="sc.sys.0030"></qp:message>
                                                                            </form:option>
                                                                            <form:options items="${CL_QP_DATATYPE}" />
                                                        ...
                                                        <c:otherwise>
                                                            <tr data-ar-rgroup="${outputBean.groupId}" class="ar-dataRow" data-ar-templateid="tbl_outputbean_list_define-template" data-ar-rindex="${outputBean.itemSequenceNo }" data-ar-rgroupindex="${outputBean.tableIndex }">
                                                                <td colspan="2" style="width: 492px">
                                                                    <div style="height: 100%">
                                                                        ...
                                                                        <div class="pull-right" style="height: 100%; vertical-align: middle;">
                                                                            ...
                                                                            <form:hidden path="outputLst[${status.index}].groupId" class="ar-groupId"/>
                                                                            <form:hidden path="outputLst[${status.index}].tableIndex" class="ar-groupIndex" />
                                                                            <form:input path="outputLst[${status.index}].decisionOutputBeanName" class="form-control qp-input-text" maxlength="200" onfocus="markValue(this)" onchange="setBeanName(this);"/>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td><form:input path="outputLst[${status.index}].decisionOutputBeanCode" class="form-control qp-input-text" maxlength="50" onfocus="markValue(this);" value="" onchange="setBeanCode(this);"/></td>
                                                                <td>
                                                                    <div>
                                                                        <form:select cssClass="form-control qp-input-select" path="outputLst[${status.index}].dataType" onfocus="markValue(this);"  onchange="changeDataType(this);">
                                                                            <form:option value="">
                                                                                <qp:message code="sc.sys.0030"></qp:message>
                                                                            </form:option>
                                                                            <form:options items="${CL_QP_DATATYPE}" />
                                        ...
                                        <div class="qp-div-action-table">
                                            <a type="button" class="btn btn-default btn-xs glyphicon glyphicon-plus qp-button-action" onclick="$.qp.ar.addRow({link:this,tableId:'tbl_output_list_result',templateId:'tbl_output_list_result-template',templateDate:{groupId:''}});"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body">
                                    <div>
                                        <table class="table table-bordered qp-table-list" id="tbl_item_condition">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th colspan="7"><qp:message code="sc.decisiontable.0018" /></th>
                                                </tr>
                                                <tr>
                                                    <th><qp:message code="sc.sys.0004" /></th>
                                ...
                                <div class="panel-body">
                                    <div>
                                        <table class="table table-bordered qp-table-list" id="tbl_item_action">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th colspan="7"><qp:message code="sc.decisiontable.0019" /></th>
                                                </tr>
                                                <tr>
                                                    <th><qp:message code="sc.sys.0004" /></th>
                ...
                <div class="form-inline form-group qp-div-action">
                    ...
                    <qp:authorization permission="decisiontableModify">
                        <button type="submit" class="btn qp-button qp-dialog-confirm" name="mode" value="2" onclick="validateSubmit">
