<tiles:insertDefinition name="layouts-popup">
	<tiles:putAttribute name="header-name">
			<qp:message code="sc.decisiontable.0049"/>
	</tiles:putAttribute>
	...
	<c:if test="${ not empty decisionTableForm}">
		<tiles:putAttribute name="body">
			<form:form method="post" action="${pageContext.request.contextPath}/decisiontable/delete" modelAttribute="decisionTableForm">
				...
				<div class="qp-div-action">
					<qp:authorization permission="decisiontableModify">
						...
						<a type="submit" class="btn qp-button qp-link-button qp-link-button" href="${pageContext.request.contextPath}/decisiontable/view?decisionTbId=${decisionTableForm.decisionTbId}&mode=1">
