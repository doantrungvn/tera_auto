...
<div class="panel panel-default qp-div-information">
	...
	<div class="panel-body">
		...
		<table class="table table-bordered qp-table-form" id="autocompleteForm1">
			...
			<tr>
				<th>
					<label for="autocompleteForm.matchingTypes" title="<qp:message code="sc.autocomplete.0009"></qp:message>"><qp:message code="sc.autocomplete.0009"></qp:message></label>
...
<div>
	<a href="javascript:void(0)" id="synchronizeLink" class="autocompleteDesign" style="float: right;margin-top: 10px">Synchronize</a>
	...
	<div class="tab-content">
		...
		<div id="tab-output" class="tab-pane" style="height: auto;">
			<jsp:include page="../autocomplete/outputForm.jsp"></jsp:include>
		</div>
