<tiles:insertDefinition name="layouts">
    ...
    <tiles:putAttribute name="breadcrumb">
         ...
         <li><span><qp:message code="sc.commonobjectdefinition.0007"/></span></li>
    </tiles:putAttribute>
	...
	<tiles:putAttribute name="body">
		<form:form method="post" action="${pageContext.request.contextPath}/commonobjectdefinition/modify" modelAttribute="commonObjectDefinitionForm">
			<c:if test="${notExistFlg ne 1}">
				<form:errors path="*" cssClass="alert qp-error" delimiter="<br/>" element="div" cssStyle="" />
				<div class="panel panel-default qp-div-information">
					<div class="panel-heading">
						<span class="glyphicon  qp-heading-icon" aria-hidden="true">&nbsp;</span> <span class="qp-heading-text"><qp:message code="sc.commonobjectdefinition.0007"></qp:message></span>
					</div>
					<div class="panel-body">
						<table class="table table-bordered qp-table-form" id="obj-infor-master-tbl">
							...
							<tr>
								...
								<td><form:input path="commonObjectDefinitionName" value="" cssClass="form-control qp-input-text qp-convention-name" maxlength="200" /></td>
								...
								<td><form:input path="commonObjectDefinitionCode" value="" cssClass="form-control qp-input-text qp-convention-code" maxlength="50" /></td>
							</tr>
							<tr>
								<th><qp:message code="sc.module.0007" /></th>
								<td><label><qp:formatText value="${commonObjectDefinitionForm.moduleIdAutocomplete}" /></label>
