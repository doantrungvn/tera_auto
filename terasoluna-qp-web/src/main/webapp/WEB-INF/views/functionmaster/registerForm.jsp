<tiles:insertDefinition name="layouts">
    ...
    <tiles:putAttribute name="breadcrumb">
         ...
         <li><span><qp:message code="sc.functionmaster.0015"/></span></li>
    </tiles:putAttribute>
	...
	<tiles:putAttribute name="body">
            <form:form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/functionmaster/register" modelAttribute="functionMasterForm">
					...
					<table class="table table-bordered qp-table-form">
						...
						<tr>
							...
							<td style="height: 23px;">
								<form:input path="file" cssClass="qp-input-file pull-right" type="file" accept=".java"/>
                                <form:hidden path="fileName" />
							</td>
							<th><qp:message code="sc.functionmaster.0030" />&nbsp;<label class="qp-required-field"><qp:message code="sc.sys.0029" /></label></th>
							<td class="word-wrap">
								<form:input type="text" cssClass="form-control qp-input-text" readonly="true" path="packageName" maxlength="50" value="${functionMasterForm.packageName}" />
							</td>
						</tr>
						<tr>
                                                                            ...
                                                                            <tbody>
                                                                                <c:forEach var="functionMethodInput" items="${functionMethod.functionMethodInput}" varStatus="statusInput">
                                                                                    <c:choose>
                                                                                        ...
                                                                                        <c:otherwise>
                                                                                            <tr data-ar-rgroup="${functionMethodInput.groupId}" class="ar-dataRow" data-ar-templateid="tblInput-attribute-template" data-ar-rindex="${functionMethodInput.itemSeqNo }" data-ar-rgroupindex="${functionMethodInput.tableIndex }">
                                                                                                <td colspan="2" style="width: 400px" >
                                                                                                    <div style="height: 100%">
                                                                                                        <div>
                                                                                                            <span class="ar-groupIndex">${functionMethodInput.tableIndex }</span>
            ...
            <div class="qp-div-action">
				<c:if test="${sessionScope.CURRENT_PROJECT.status eq 1 }">
					<qp:authorization permission="functionmasterRegister">
						<button type="submit" class="btn qp-button qp-dialog-confirm" data-confirm-pcallback="checkFileSize" onclick="saveFunctionMaster"><qp:message code="sc.sys.0031" /></button>
					</qp:authorization>
				</c:if>
			</div>
		</form:form>
