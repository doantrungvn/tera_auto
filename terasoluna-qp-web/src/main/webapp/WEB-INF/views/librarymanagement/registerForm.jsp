<tiles:insertDefinition name="layouts">
    ...
    <tiles:putAttribute name="breadcrumb">
         ...
         <li><span><qp:message code="sc.librarymanagement.0003"/></span></li>
    </tiles:putAttribute>
	...
	<tiles:putAttribute name="body">
		...
		<form:form method="post"
			...
			action="${pageContext.request.contextPath}/librarymanagement/register"
				...
				<div class="panel-body">
					<table class="table table-bordered qp-table-form">
						...
						<tr>
							...
							<td><form:input path="groupId" cssClass="form-control qp-input-text" maxlength="150" /></td>
							<th>
							...
							<td><form:input path="artifactId" cssClass="form-control qp-input-text" maxlength="150" /></td>
						</tr>
						<tr>
							<th>
								<form:label path="version"><qp:message code="sc.librarymanagement.0007"/></form:label>
							...
							<td>
								<form:input path="version" cssClass="form-control qp-input-text" maxlength="150" />
							</td>
							<th>
								<form:label path="classifier"><qp:message code="sc.librarymanagement.0008"/></form:label>
							...
							<td>
								<form:input path="classifier" cssClass="form-control qp-input-text" maxlength="150" />
							</td>
						</tr>
						<tr>
							<th>
							...
							<th>
								<form:label path="type"><qp:message code="sc.librarymanagement.0010"/></form:label>
						...
						<tr>
							...
							<td colspan="3">
								...
								<form:input path="uploadFileContent" cssClass="upload qp-input-file pull-right" type="file" accept=".jar"/>
							</td>
						</tr>
					</table>
				</div>
