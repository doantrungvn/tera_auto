<tiles:insertDefinition name="layouts">
	...
	<tiles:putAttribute name="breadcrumb">
		...
		<li><span><qp:message code="sc.externalobjectdefinition.0006" /></span></li>
	</tiles:putAttribute>
	...
	<tiles:putAttribute name="body">
		<form:form method="post" action="${pageContext.request.contextPath}/externalobjectdefinition/register" modelAttribute="externalObjectDefinitionForm">
			<form:errors path="*" cssClass="alert qp-error" delimiter="<br/>" element="div" cssStyle="" />
			<div class="panel panel-default qp-div-information">
				<div class="panel-heading">
					<span class="glyphicon  qp-heading-icon" aria-hidden="true">&nbsp;</span> <span class="qp-heading-text"><qp:message code="sc.externalobjectdefinition.0006"></qp:message></span>
				</div>
				<div class="panel-body">
					<table class="table table-bordered qp-table-form">
						...
						<tr>
							...
							<td><form:input path="externalObjectDefinitionName" cssClass="form-control qp-input-text qp-convention-name" maxlength="200" /></td>
							...
							<td><form:input path="externalObjectDefinitionCode" cssClass="form-control qp-input-text qp-convention-code" maxlength="50" /></td>
						</tr>
						<tr>
							<th><form:label path="">
									<qp:message code="sc.module.0007" />
								</form:label></th>
							<td><qp:autocomplete optionValue="optionValue" optionLabel="optionLabel" selectSqlId="getAllModuleByModuleNameAndProjectIdForAutocomplete" arg01="${sessionScope.CURRENT_PROJECT.projectId}" value="${externalObjectDefinitionForm.moduleId}" name="moduleId" displayValue="${externalObjectDefinitionForm.moduleIdAutocomplete}" mustMatch="true" maxlength="200" onChangeEvent="changeModule">
								</qp:autocomplete></td>
					...
					<table class="table table-bordered qp-table-list" id="tbl_attribute_list_define" data-ar-dataClass="ar-dataRow" data-ar-callback="changeRowOfAttributeCallBackfunction">
						...
						<thead>
							<tr>
								...
								<th><qp:message code="sc.externalobjectdefinition.0009"></qp:message></th>
