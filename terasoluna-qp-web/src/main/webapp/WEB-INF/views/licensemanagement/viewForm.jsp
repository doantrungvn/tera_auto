<tiles:insertDefinition name="layouts-popup">
	<tiles:putAttribute name="header-name">	
		<qp:message code="sc.permission.licensemanagementView.remark"/>
	</tiles:putAttribute>
	...
	<tiles:putAttribute name="body">
		<c:if test="${notExistFlg ne 1}">
			<div id="wapper">
				<form:form method="post" action="${pageContext.request.contextPath}/licensemanagement/delete" modelAttribute="licenseManagementForm">
					<div class="panel panel-default qp-div-information">
						...
						<div class="panel-body">
							<table class="table table-bordered qp-table-form">
								...
								<tr>
									...
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.customerName}" /></td>
									<th><qp:message code="sc.licensemanagement.0000"/></th>
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.customerCode}" /></td>
								</tr>
								<tr>
									<th><qp:message code="sc.licensemanagement.0004"/></th>
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.tel}" /></td>
									<th><qp:message code="sc.licensemanagement.0005"/></th>
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.email}" /></td>
								</tr>
								<tr>
									<th><qp:message code="sc.licensemanagement.0006"/></th>
									<td class="word-wrap"><qp:formatRemark value="${licenseManagementForm.address}" /></td>
									<th></th>
									<td></td>
								</tr>
								<tr class="success form-inline">
								...
								<tr>
									...
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.projectName}" /></td>
									<th><qp:message code="sc.licensemanagement.0002"/></th>
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.projectCode}" /></td>
								</tr>
								<tr>
									<th><qp:message code="sc.licensemanagement.0007"/></th>
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.num}" /></td>
									<th><qp:message code="sc.licensemanagement.0008"/></th>
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.version}" /></td>
								</tr>
								<tr>
									<th><qp:message code="sc.licensemanagement.0009"/></th>
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.startDate}" /></td>
									<th><qp:message code="sc.licensemanagement.0010"/></th>
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.expiredDate}" /></td>
								</tr>
								<tr>
									<th><qp:message code="sc.licensemanagement.0014"/></th>
									<td class="word-wrap"><qp:formatText value="${licenseManagementForm.appliedDate}" /></td>
									<th><qp:message code="sc.licensemanagement.0013"/></th>
									<td class="word-wrap"><qp:formatText value="${CL_LICENSEMANAGEMENT_STATUS.get(licenseManagementForm.status.toString())}" /></td>
								</tr>
							</table>
						</div>
					</div>
						<div class="qp-div-action">
								...
								<qp:authorization permission="licensemanagementDelete">
