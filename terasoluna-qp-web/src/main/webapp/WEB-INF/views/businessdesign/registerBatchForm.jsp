<tiles:insertDefinition name="layouts">
	...
	<tiles:putAttribute name="breadcrumb">
		...
		<li>
			<span><qp:message code="sc.businesslogicdesign.0270" /></span>
		</li>
	</tiles:putAttribute>
	...
	<tiles:putAttribute name="body">
		...
		<form:form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/businessdesign/registerBatch" modelAttribute="businessDesignForm">
			...
			<div class="panel panel-default qp-div-information">
				...
				<div class="panel-body">
					<table class="table table-bordered qp-table-form" id="tbl-blogicinformation">
						...
						<tr>
                            <th><form:label path="batchType"><qp:message code="sc.businesslogicdesign.0169" />&nbsp;<label class="qp-required-field"><qp:message code="sc.sys.0029" /></label></form:label></th>
                            <td colspan="3">
                                <c:forEach var="item" items="${CL_BATCH_TYPE}">
                                    <label><form:radiobutton path="batchType" value="${item.key}" cssClass="qp-input-radio-margin  qp-input-radio" /> <qp:message code="${item.value}" /></label>
                                </c:forEach>
                            </td>
						</tr>
						<tr >
