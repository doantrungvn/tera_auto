<!-- Dialog set scope setting -->
<div id="dialog-setscope-setting" class="modal fade" style="display: none;">
    <input type="hidden" name="dataTypeOutput" />
    <input type="hidden" name="arrayFlgOutput" />
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn qp-button-client " onclick="saveDialogSetScope(this)">
