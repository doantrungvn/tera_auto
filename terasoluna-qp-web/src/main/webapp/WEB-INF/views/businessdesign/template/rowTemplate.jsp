...
<script id="tbl_inputbean_list_define-template" type="text/template">
	<tr data-ar-rgroup="\${groupId}" class="ar-dataRow">
		...
		<td  class="bd-in-screenitem-hidden">
			<label name="lstInputBean[].screenItemIdAutocomplete" class="qp-output-text"></label>
			<input type="hidden" name="lstInputBean[].screenItemId" value=""/>
			<input type="hidden" name="lstInputBean[].mappingType" value=""/>
			<input type="hidden" name="lstInputBean[].itemName" value=""/>
		</td>
		<td class="bd-in-getscope" align="center">
			<div class="dropdown">
				...
				<ul class="dropdown-menu dropdown-nav-left">
					<li>
						<input type="hidden" name="lstInputBean[].scopeType" value="0" />
						<input type="hidden" name="lstInputBean[].scopeValue" />
						<input type="hidden" name="lstInputBean[].scopeValueAutocomplete" />
						<input type="hidden" name="lstInputBean[].dataTypeSession" />
						<input type="hidden" name="lstInputBean[].arrayFlagSession" />
...
<script id="tbl_inputbean_list_define-column-template" type="text/template">
    <tr data-ar-rgroup="\${groupId}" class="ar-dataRow">
		...
		<td  class="bd-in-screenitem-hidden">
			<label name="lstInputBean[].screenItemIdAutocomplete" class="qp-output-text"></label>
			<input type="hidden" name="lstInputBean[].screenItemMapping.screenItemId" value=""/>
			<input type="hidden" name="lstInputBean[].screenItemMapping.mappingType" value=""/>
			<input type="hidden" name="lstInputBean[].screenItemMapping.itemName" value=""/>
			<span title='<qp:message code="sc.businesslogicdesign.0261" />' class="btn btn-default btn-xs glyphicon glyphicon-list-alt qp-button-action bd-in-screenitem-hidden qp-cursor" style="display:none;float: right; margin-right: 5px;" onclick="openModalAssignScreenItem(this,true,0)"></span>
		</td>
        <td class="bd-in-getscope" align="center">
			<div class="dropdown">
				<button class="btn btn-info glyphicon glyphicon-menu-hamburger qp-link-button qp-link-action" type="button" data-toggle="dropdown"></button>
				<ul class="dropdown-menu dropdown-nav-left">
					...
					<li>
						<input type="hidden" name="lstInputBean[].jsonValidationInputs" />
						<!--<a name="btnOpenValidationCheck" style='display:none' class="qp-link qp-cursor" onclick="openModalValidationCheckDetail(this)"><qp:message code="sc.businesslogicdesign.0263"/></a>-->
					</li>
				</ul>
			</div>
		</td>
...
<script id="tbl_outputbean_list_define-template" type="text/template">
    <tr data-ar-rgroup="\${groupId}" class="ar-dataRow">
		...
		<td  class="bd-ou-screenitem-hidden">
			<label name="lstOutputBean[].screenItemIdAutocomplete" class="qp-output-text"></label>
			<input type="hidden" name="lstOutputBean[].screenItemId" value=""/>
			<input type="hidden" name="lstOutputBean[].mappingType" value=""/>
			<input type="hidden" name="lstOutputBean[].itemName" value=""/>
		...
		<td class="bd-ou-setscope" align="center">
			<div class="dropdown">
				<button class="btn btn-info glyphicon glyphicon-menu-hamburger qp-link-button qp-link-action" type="button" data-toggle="dropdown"></button>
				<ul class="dropdown-menu dropdown-nav-left">
					<li>
						<input type="hidden" name="lstOutputBean[].scopeType" value="0" />
						<input type="hidden" name="lstOutputBean[].scopeValue" />
						<input type="hidden" name="lstOutputBean[].scopeValueAutocomplete" />
						<input type="hidden" name="lstOutputBean[].dataTypeSession" />
						<input type="hidden" name="lstOutputBean[].arrayFlagSession" />
