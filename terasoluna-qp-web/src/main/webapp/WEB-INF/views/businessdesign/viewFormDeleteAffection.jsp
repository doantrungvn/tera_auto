<tiles:insertDefinition name="layouts-popup">
	<tiles:putAttribute name="header-name">
		<qp:message code="sc.businesslogicdesign.0172" />
	</tiles:putAttribute>
	<tiles:putAttribute name="body">
		<form:form method="post" modelAttribute="businessDesignForm" action="${pageContext.request.contextPath}/businessdesign/delete">
			...
			<c:if test="${not empty businessDesignForm.businessLogicId}">
				...
				<div class="qp-div-action">
					<qp:authorization permission="businesslogicView">
						<a href="${pageContext.request.contextPath}/businessdesign/view?businessLogicId=${f:h(businessDesignForm.businessLogicId)}&openOwner=1&mode=0&showImpactFlag=${f:h(businessDesignForm.showImpactFlag)}"  class="btn qp-button qp-link-button qp-link-button"><qp:message code="sc.sys.0023" /></a>
					</qp:authorization>
					<qp:authorization permission="deleteObjectHasFk">
						<button type="submit" class="btn btn-warning qp-dialog-confirm" messageId="inf.sys.0014">
