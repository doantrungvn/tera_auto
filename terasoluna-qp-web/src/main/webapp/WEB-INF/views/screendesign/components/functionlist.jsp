...
<div id="dialog-function-display" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<script id="tbl-function-list-template" type="text/x-jquery-tmpl">
		<tr>
			<td>\${idx}</td>
			<td rowspan="1" style="text-align: left" class="com-output-fixlength">\${functionMasterCode}</td>
			<td style="text-align: left">\${functionMethodCode}</td>
			<td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="panel panel-default  qp-div-information">
					<div class="panel-heading">
						...
						<span class="pq-heading-text"><qp:message code="sc.businesslogicdesign.0165"/></span>
					</div>
					<div class="panel-body">
						<table class="table table-bordered qp-table-list" id="tbl-function-list">
							<colgroup>
								<!-- <col /> -->
								<col>
								<col width="40%" />
							...
							<thead>
								<tr>
									...
									<th style="text-align: center"><qp:message code="sc.businesslogicdesign.0119"/></th>
								</tr>
							</thead>
							<tbody>
							</tbody>
			...
			<div class="modal-footer">	
				<div class="qp-div-action">
        			<button type="button" class="btn qp-button-client " onclick="$.qp.functions.saveSelectMethod(this);"><qp:message code="sc.sys.0031"></qp:message></button>
			</div>
			</div>
		</div>
	</div>
