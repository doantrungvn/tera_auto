		    	...
		    	<div class="modal-content">		   
		    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>  
		      		...
		      		<div class="modal-footer">
		        		<button type="button" class="btn qp-button-client " onclick="deleteDialogLinkAreaSetting(this, 'dialog-link-area-setting-section')"><qp:message code="sc.sys.0014"></qp:message> </button>
		        		<button type="button" class="btn qp-button-client " onclick="saveDialogLinkAreaSetting(this, 'dialog-link-area-setting-section')"><qp:message code="sc.sys.0054"></qp:message> </button>
		      		</div>					
				</div>
			</div>