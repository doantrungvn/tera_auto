					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#modal-table-list-setting-properties"
														...
														<td>
															...
															<div style="width: 100px; float: left; margin-left: 4px;" id="fixedRowDiv">
																<c:if test="${screenDesignForm.screenPatternType == 2 || screenDesignForm.screenPatternType == 4 }">
																	<input onclick="setValueFixedRow(this)" type="checkbox" name="fixedRow" checked="checked" id="fixedrow"/>&nbsp;<span id="commentFixedRow"><label for="fixedrow">(Fixed row)</label></span> 
																</c:if>
																<c:if test="${screenDesignForm.screenPatternType == 1 || screenDesignForm.screenPatternType == 3 }">
																	<input onclick="setValueFixedRow(this)" type="checkbox" name="fixedRow" id="fixedrow"/>&nbsp;<span id="commentFixedRow"><label for="fixedrow">(Fixed row)</label></span> 
																</c:if>
															</div>
