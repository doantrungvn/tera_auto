		    		...
		    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>  	     
		      		<div class="modal-body">
		      			<ul class="nav nav-tabs">
							<li class="active">
								<a href="#dialog-link-setting-properties" data-toggle="tab"><qp:message code="sc.screendesign.0064"></qp:message></a>
							</li>
								...
								<div class="panel panel-default qp-div-information">
									...
									<div class="panel-body">
										<table class="table table-bordered qp-table-form">
											...
											<tr>
												<th>Transition node&nbsp;<label class="qp-required-field">(*)</label></th>
		      		...
		      		<div class="modal-footer">
		        		<button type="button" class="btn qp-button-client " onclick="deleteDialogLinkSetting(this)"><qp:message code="sc.sys.0014"></qp:message></button>
		        		<button type="button" class="btn qp-button-client " onclick="saveDialogLinkSetting(this)"><qp:message code="sc.sys.0054"></qp:message></button>
		      		</div>					
				</div>
			</div>