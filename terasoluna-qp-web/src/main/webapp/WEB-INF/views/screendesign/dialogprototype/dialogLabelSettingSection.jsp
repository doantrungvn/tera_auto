		    		...
		    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>  		     
		      		<div class="modal-body" >
		      			<ul class="nav nav-tabs">
							<li class="active"><a href="#dialog-label-section-setting-properties" data-toggle="tab"><qp:message code="sc.screendesign.0064"></qp:message></a></li>
							<li><a href="#dialog-label-section-setting-style" data-toggle="tab"><qp:message code="sc.screendesign.0339"/></a></li>							
						</ul>
						<div class="tab-content">
							<div id="dialog-label-section-setting-properties" class="tab-pane active">
				      			<div class="panel panel-default qp-div-information">
									<div class="panel-heading">
										<span aria-hidden="true" class="glyphicon  qp-heading-icon">&nbsp;</span>
										<span class="pq-heading-text"><qp:message code="sc.screendesign.0102"></qp:message></span>
									</div>
									<div class="panel-body" style="height: 250px;">
				       					<table class="table table-bordered qp-table-form">
											...
											<tr>
												<th><qp:message code="sc.screendesign.0103"></qp:message> &nbsp;<label class="qp-required-field"><qp:message code="sc.sys.0029" /></label></th>																							
												<td>													
											...
											<%-- <tr>
												<th><qp:message code="sc.screendesign.0101"></qp:message></th>
												<td><input name="isBlank" onclick="dialogLableSettingChecked('dialog-label-setting-section')" type="checkbox" class="qp-input-checkbox-margin qp-input-checkbox"></td>
											</tr>
											<tr> --%>
										</table>
				      				</div>
		      				...
		      				<div id="dialog-label-section-setting-style" class="tab-pane">
									<div class="panel panel-default  qp-div-information">
										<div class="panel-heading">
		      		...
		      		<div class="modal-footer">
		        		<button type="button" class="btn qp-button-client " onclick="deleteDialogLableSetting('dialog-label-setting-section')"><qp:message code="sc.sys.0014"></qp:message></button>
		        		<button type="button" class="btn qp-button-client " onclick="saveDialogLableSetting('dialog-label-setting-section')"><qp:message code="sc.sys.0054"></qp:message></button>
		      		</div>
		   	 	</div>
		  	</div>