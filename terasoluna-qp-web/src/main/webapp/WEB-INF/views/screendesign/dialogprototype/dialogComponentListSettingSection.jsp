		    		...
		    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>
		      		<div class="modal-body">
		      			<ul class="nav nav-tabs">
							<li class="active">
								<a href="#dialog-component-list-setting-section-properties" data-toggle="tab"><qp:message code="sc.screendesign.0064"></qp:message></a>
							</li>
							<li><a href="#dialog-component-list-setting-section-codelist" data-toggle="tab"><qp:message code="sc.screendesign.0148"></qp:message></a></li>
						...
						<div class="tab-content" >
									...
									<div class="panel-body">
										<table class="table table-bordered qp-table-form">
											...
											<tr>
												...
												<td>
													<div class="radio">
														<label class="radio-inline"><input type="radio" name="localCodelist" value="1" onchange="changeTypeCodeList(this)"><qp:message code="sc.screendesign.0213" /></label>
			      		...
			      		<div class="modal-footer">
			        		<button type="button" class="btn qp-button-client " onclick="deleteDialogComponentListSetting('dialog-component-list-setting-section')"><qp:message code="sc.sys.0014"></qp:message></button>
			        		<button type="button" class="btn qp-button-client " onclick="saveDialogComponentListSetting('dialog-component-list-setting-section')"><qp:message code="sc.sys.0054"></qp:message></button>
			      		</div>
		   	 		</div>
		  		</div>
			</div>