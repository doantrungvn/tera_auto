		    		...
		    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>  		     
		      		<div class="modal-body">
		      			<ul class="nav nav-tabs">
							<li class="active">
								<a href="#dialog-component-setting-section-properties" data-toggle="tab"><qp:message code="sc.screendesign.0064"></qp:message></a>
							</li>
						...
						<div class="tab-content" style="min-height: 450px;width: 570px;">
			      		...
			      		<div class="modal-footer">
			        		<button type="button" class="btn qp-button-client " onclick="deleteDialogComponentSetting('dialog-component-setting-section')"><qp:message code="sc.sys.0014"></qp:message></button>
			        		<button type="button" class="btn qp-button-client " onclick="saveDialogComponentSetting('dialog-component-setting-section')"><qp:message code="sc.sys.0054"></qp:message></button>
			      		</div>
		   	 		</div>
		  		</div>
			</div>