		    		...
		    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>  		     
		      		<div class="modal-body">
		      			<ul class="nav nav-tabs">
							<li class="active">
								<a href="#dialog-component-autocomplete-setting-section-properties" data-toggle="tab"><qp:message code="sc.screendesign.0064"/></a>
							</li>
							<li><a href="#dialog-component-autocomplete-setting-section--autocomplete-setting" data-toggle="tab"><qp:message code="sc.screendesign.0099"/></a></li>
							<li><a href="#dialog-component-autocomplete-setting-section-autocomplete-style" data-toggle="tab"><qp:message code="sc.screendesign.0339"/></a></li>
						</ul>
						<div class="tab-content" style="min-height: 450px;">
							<div id="dialog-component-autocomplete-setting-section-properties" class="tab-pane active">
							...
							<div id="dialog-component-autocomplete-setting-section--autocomplete-setting" class="tab-pane">
								<div class="panel panel-default qp-div-information">
										<div class="panel-heading">
											<span aria-hidden="true" class="glyphicon  qp-heading-icon">&nbsp;</span>
										...
										<div class="panel-body">
											<table class="table table-bordered qp-table-form" id="sql-setting">
												...
												<tr>
													...
													<td>
														<qp:autocomplete mustMatch="false" name="sqldesignid" arg03="${screenDesignForm.moduleId}" arg02="20" arg01="${f:h(sessionScope.CURRENT_PROJECT.projectId)}" optionLabel="optionLabel" optionValue="optionValue" onChangeEvent="findColumnByDatasource" selectSqlId="getSqlBuilderAutocomplete"/>
													</td>
												</tr>
												<tr>
							...
							<div id="dialog-component-autocomplete-setting-section-autocomplete-style" class="tab-pane">
									<div class="panel panel-default  qp-div-information">
										<div class="panel-heading">
		      		...
		      		<div class="modal-footer">
		        		<button type="button" class="btn qp-button-client " onclick="deleteDialogAutocompleteSetting(this,'dialog-component-autocomplete-setting-section')"><qp:message code="sc.sys.0014"/></button>
		        		<button type="button" class="btn qp-button-client " onclick="saveDialogAutocompleteSetting(this,'dialog-component-autocomplete-setting-section')"><qp:message code="sc.sys.0054"/></button>
		      		</div>					
				</div>
			</div>