<script id="tbl-ifcondition-template" type="text/template">
	<tr>
		...
		<td><input type="text" class="form-control" name="caption" /></td>
		<td>
            <div style="width: 100%">
				...
				<div class="panel panel-default  qp-div-information">
					...
					<div class="panel-body">
							...
							<tbody>
						    	<tr>
							        ...
							        <td class="form-inline">
							            <input type="text" style="width: 100%" class="form-control qp-input-text" name="label"/>
							        </td>
							    </tr>
							    <tr>
							        <th><qp:message code="sc.businesslogicdesign.0064"/></th>
							        <td class="form-inline">
							            <textarea rows="2" cols="1" style="width: 100%" name="remark"></textarea>
							        </td>
							    </tr>
							</tbody>
                        </table>
						...
						<div class="qp-add-left">
	                    	<a class="btn btn-default btn-xs glyphicon glyphicon-plus qp-button-action" onclick="$.qp.addRowJSByLinkEx(this,'tbl-ifcondition','tbl-ifcondition-template');" style="margin-top: 3px;" href="javascript:void(0)"></a>
	                   	</div>
						<br />
					</div>
				</div>
