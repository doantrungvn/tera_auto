		    		...
		    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>
		      		<div class="modal-body">
		      			<ul class="nav nav-tabs">
							<li class="active">
								<a href="#dialog-component-list-setting-section-properties" data-toggle="tab"><qp:message code="sc.screendesign.0064"/></a>
							</li>
							<li><a href="#dialog-component-list-setting-section-codelist" data-toggle="tab"><qp:message code="sc.screendesign.0198"/></a></li>
							<li><a href="#dialog-component-list-setting-section-event" data-toggle="tab"><qp:message code="sc.screendesign.0065"/></a></li>
							<li><a href="#dialog-component-list-setting-section-style" data-toggle="tab"><qp:message code="sc.screendesign.0339"/></a></li>
						</ul>
						<div class="tab-content" >
							<div id="dialog-component-list-setting-section-properties" class="tab-pane active">
							...
							<div id="dialog-component-list-setting-section-codelist" class="tab-pane" style="min-height: 200px">
								<div class="panel panel-default qp-div-information">
									<div class="panel-heading">
										<span aria-hidden="true" class="glyphicon  qp-heading-icon">&nbsp;</span>
									...
									<div class="panel-body">
										...
										<table class="table table-bordered qp-table-form">
											...
											<tr id="showBlankItemLayout">
												...
												<td>
													<label><input class="qp-input-checkbox-margin qp-input-checkbox" name="showBlankItem" value="1"  type="checkbox" /></label>	
												</td>
											</tr>
										</table>
										<br />
										<div class="panel-group" id="accordion">
											        ...
											        <table class="table table-bordered qp-table-form" id="codelist-setting">
														...
														<tr class="codelist-system">
															<th>
																<qp:message code="sc.screendesign.0095"/>
															</th>
															<td>
							...
							<div id="dialog-component-list-setting-section-event" class="tab-pane">
								<div class="panel panel-default  qp-div-information">
									<div class="panel-heading">
							...
							<div id="dialog-component-list-setting-section-style" class="tab-pane">
									<div class="panel panel-default  qp-div-information">
										<div class="panel-heading">
											<span class="glyphicon  qp-heading-icon" aria-hidden="true">&nbsp;</span>
															...
															<tr>
																<td>
																	<div class="input-group">
																		<input class="form-control qp-input-integer" name="margin-left" type="text" value=""> <span class="hex-pound input-group-addon"><qp:message code="sc.screendesign.0147"/></span>
																	</div>
																</td>
																<td>
																	<div class="input-group">
			      		...
			      		<div class="modal-footer">
			        		<button type="button" class="btn qp-button-client " onclick="deleteDialogComponentListSetting('dialog-component-list-setting-section')"><qp:message code="sc.sys.0014"/></button>
			        		<button type="button" class="btn qp-button-client " onclick="saveDialogComponentListSetting('dialog-component-list-setting-section')"><qp:message code="sc.sys.0054"/></button>
			      		</div>
		   	 		</div>
		  		</div>
			</div>