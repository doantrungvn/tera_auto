		    		...
		    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>  		     
		      		<div class="modal-body">
		      			<ul class="nav nav-tabs">
							<li class="active"><a href="#dialog-component-setting-section-properties" data-toggle="tab"><qp:message code="sc.screendesign.0064"/></a></li>
							<li><a href="#dialog-component-setting-section-codelist" data-toggle="tab"><qp:message code="sc.screendesign.0198"/></a></li>
							<li><a href="#dialog-component-setting-section-style" data-toggle="tab"><qp:message code="sc.screendesign.0339"/></a></li>
						</ul>
						<div class="tab-content">
							<div id="dialog-component-setting-section-properties" class="tab-pane active">
							...
							<div id="dialog-component-setting-section-codelist" class="tab-pane" style="min-height: 200px">
								<div class="panel panel-default qp-div-information">
									<div class="panel-heading">
										<span aria-hidden="true" class="glyphicon  qp-heading-icon">&nbsp;</span>
										...
										<div class="panel-group" id="accordion">
											        ...
											        <table class="table table-bordered qp-table-form" id="codelist-setting">
														...
														<tr class="codelist-screen">
															<th>Screen name</th>
															<td><qp:autocomplete optionLabel="optionLabel"  optionValue="optionValue" onChangeEvent="changeScreenId" mustMatch="false" name="screenNameCodeList"  selectSqlId="getAllScreenOfModule" arg01="${screenDesignForm.moduleId}"/></td>
														</tr>
														<tr class="codelist-screen">
															<th>Screen item name</th>
															<td><qp:autocomplete optionLabel="optionLabel"  optionValue="optionValue" mustMatch="false" onChangeEvent="changeScreenItemId" name="screenItemCodeList" selectSqlId="getAllItemCodeListScreenOfScreen" /></td>
														</tr>
														<tr class="codelist-screen">
															<td colspan="2">
																<div class="checkbox">
							...
							<div id="dialog-component-setting-section-style" class="tab-pane">
									<div class="panel panel-default  qp-div-information">
										<div class="panel-heading">
			      		...
			      		<div class="modal-footer">
			        		<button type="button" class="btn qp-button-client " onclick="deleteDialogComponentSetting('dialog-component-setting-section')"><qp:message code="sc.sys.0014"/></button>
			        		<button type="button" class="btn qp-button-client " onclick="saveDialogComponentSetting('dialog-component-setting-section')"><qp:message code="sc.sys.0054"/></button>
			      		</div>
		   	 		</div>
		  		</div>
			</div>