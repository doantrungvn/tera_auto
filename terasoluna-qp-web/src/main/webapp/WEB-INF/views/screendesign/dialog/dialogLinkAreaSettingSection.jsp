	    		...
	    		<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>  	     
	      		<div class="modal-body">
	      			<ul class="nav nav-tabs">
						<li class="active"><a href="#dialog-link-area-section-setting-properties" data-toggle="tab"><qp:message code="sc.screendesign.0064"/></a></li>
						<li><a href="#dialog-link-area-section-setting-codelist" data-toggle="tab"><qp:message code="sc.screendesign.0198"/></a></li>
						<li><a href="#dialog-link-area-section-setting-style" data-toggle="tab"><qp:message code="sc.screendesign.0339" /></a></li>
					</ul>
					<div class="tab-content" style="min-height: 330px;">
						<div id="dialog-link-area-section-setting-properties" class="tab-pane active">
							<div class="panel panel-default qp-div-information">
								...
								<div class="panel-body">
									<table class="table table-bordered qp-table-form">
										...
										<tr class="widthDynamicLink"><td colspan="2"></td></tr>
										<tr class="widthDynamicLink">
						...
						<div id="dialog-link-area-section-setting-codelist" class="tab-pane" style="min-height: 200px">
								<div class="panel panel-default qp-div-information">
									<div class="panel-heading">
										<span aria-hidden="true" class="glyphicon  qp-heading-icon">&nbsp;</span>
																	...
																	<thead>
																		<tr>
																			...
																			<th class="colOptionName">
																				<qp:message code="sc.screendesign.0201"/>&nbsp;<label class="qp-required-field"><qp:message code="sc.sys.0029" /></label>
																			</th>
																			<th>
						...
						<div id="dialog-link-area-section-setting-style" class="tab-pane">
									<div class="panel panel-default  qp-div-information">
										<div class="panel-heading">
	      		...
	      		<div class="modal-footer">
	        		<button type="button" class="btn qp-button-client " onclick="deleteDialogLinkAreaSetting(this,'dialog-link-area-setting-section')"><qp:message code="sc.sys.0014"/></button>
	        		<button type="button" class="btn qp-button-client " onclick="saveDialogLinkAreaSetting(this,'dialog-link-area-setting-section')"><qp:message code="sc.sys.0054"/></button>
	      		</div>					
			</div>
		</div>