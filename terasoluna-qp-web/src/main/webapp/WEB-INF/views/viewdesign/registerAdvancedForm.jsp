<tiles:insertDefinition name="layouts">
    ...
    <tiles:putAttribute name="breadcrumb">
         ...
         <li><span><qp:message code="sc.viewdesign.0004"/></span></li>
    </tiles:putAttribute>
	...
	<form:form method="post" action="${pageContext.request.contextPath}/viewdesign/registerAdvanced" modelAttribute="viewDesignAdvancedDesignForm">
