<tiles:insertDefinition name="layouts">
	...
	<tiles:putAttribute name="header-name">	
		<tiles:putAttribute name="breadcrumb">
			...
			<li><span><qp:message code="sc.importschema.0005"/></span></li>
		</tiles:putAttribute>
	</tiles:putAttribute>

	<tiles:putAttribute name="body">
		<jsp:include page="../graphicdatabasedesign/dialogRemark.jsp"></jsp:include>
		<form:form method="post" id="formSave" action="${pageContext.request.contextPath}/importschema/importToDb" modelAttribute="graphicDbDesignForm">
			<input type="hidden" name="formJson" value="${f:h(formJson)}" />
			<form:hidden path="jSonString" value="${graphicDbDesignForm.formJson}"/>
			...
			<div class="panel panel-default qp-div-information">
				...
				<c:if test="${not empty graphicDbDesignForm.projectId}">
					<div class="com-body-panel">
						<div class="qp-div-action" style="text-align:right; padding-left: 10px;">
							<qp:authorization permission="importschema">
								...
								<button type="submit" class="btn qp-button qp-dialog-confirm" onclick="submitForm"><qp:message code="sc.sys.0018" /></button>
							</qp:authorization>
