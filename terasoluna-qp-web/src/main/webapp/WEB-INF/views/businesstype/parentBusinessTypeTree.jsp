<div class="btn-group qp-input-customselect">
	<form:input type="text" path="parentBusinessTypeName" cssClass="form-control dropdown-toggle" data-toggle="dropdown" maxlength="200" /> 
	<form:hidden path="parentBusinessTypeId" />
	<span class="caret"></span>
	<ul class="dropdown-menu" id="parentBusinessType"></ul>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			businessType.show('parentBusinessType');
			
			$("input[id='parentBusinessTypeName']").change(function(){
				var inputText = $(this);
