...
function returnCustomSection(code){
	return "<div class=\"areaContent\"><div class=\"panel panel-default\"><div class=\"panel-heading\" style=\"background-color:#ebebe1;color: #337AB7;\"><span class=\"glyphicon\" aria-hidden=\"true\"></span><span class=\"qp-heading-text\">" +
		...
		"<span style=\"float:left; margin-top: 3px; margin-right: 5px;\">Custom section</span>" +
		"<a href=\"javascript:\" style=\"float: right; margin-top: 3px;color: #337AB7;\" onclick=\"deleteTable(this)\" class=\"ui-state-default glyphicon glyphicon-remove\" title=\""+dbMsgSource['sc.screendesign.0136']+"\"></a>" +
		"<input type=\"hidden\" name=\"formAreaCaptionText\"/>" +
		"<input type=\"hidden\" name=\"formAreaCaptionId\"/>" +
		"<input type=\"hidden\" value=\""+code+"\" name=\"formAreaCode\"/>" + 
...
function returnElementTDAddEntity(item){	
	...
	if (dataType == 5 || dataType == 6 || dataType == 7) {
		...
		datasourcetype = checkUndefined(item.datasourcetype);
	}
	...
	if(dataType == 24){
		...
		elementLabel += "\",\"require\":\""+require+"\",\"elementtype\":\"0\"'>";
		elementTD += "<span><label ondblclick=\"openDialogCustomSetting(this, true)\" style=\"cursor: pointer;\">"+item.label+"</label>"+elementLabel+"</span>";
	}	
...
function returnElementTDLoad(item, displayGroupType){	
	...
	if(dataType == 0){
		elementTD += "<span "+style+">" +
				"<div ondblclick=\"openDialogAutocompleteSetting(this)\" class=\"input-group\" style=\"width:100%;"+ item.inputStyle + ' ' +item.style+"\"><input type=\"text\" ";
				if(item.elementtype == 0){
					elementTD += " class=\"form-control ui-autocomplete-input\" ";
				} else {
					elementTD += " class=\"qp-input-autocomplete\" ";
	...
	if(dataType == 4){
		...
		elementTD += "<span><input style=\""+ item.inputStyle + ' ' +item.style+"\" ondblclick=\"openDialogComponentSetting(this)\" type=\"text\" ";
						if(item.elementtype == 0){
							elementTD += "class=\"form-control\"";
						} else {
							elementTD += "class=\"form-control\"";
	...
	if(dataType == 5){
		if(item.msgvalue != undefined && item.msgvalue.length > 0){
			...
			$(msgValArr).each(function(j){
				...
				if(item.msglabel == undefined || item.msglabel.length == 0  || (msgLabelArr[j] == null || msgLabelArr[j] == 'null')){					
					elementTD += " name=\"" + item.columnname + "1\" /><label style=\""+ item.inputStyle + ' ' +item.style+"\" for=\""+item.columnname+"\">"+msgValArr[j]+"</label>";
				} else {					
	...
	if(dataType == 7){
		...
		if(item.msgvalue != undefined && item.msgvalue.length > 0){
			...
			$(msgValArr).each(function(j){
				if(item.msglabel == undefined || item.msglabel.length == 0  || (msgLabelArr[j] == null || msgLabelArr[j] == 'null')){
					elementTD += "<option value=\""+msgValArr[j]+"\">" + msgValArr[j] + "</option>";
				} else {
					elementTD += "<option value=\""+msgValArr[j]+"\">" + msgLabelArr[j] + "</option>";
				}
			});
		} else {
			elementTD += "<option></option><option>"+dbMsgSource['sc.screendesign.0137']+"1</option><option>"+dbMsgSource['sc.screendesign.0137']+"2</option>";
	...
	if(dataType == 13){
		...
		if (item.icon != undefined && item.showLabel != undefined && item.icon.length > 0) {
			...
			elementTD += "<span "+style+"><button style=\""+ item.inputStyle + ' ' +item.style+";width:100%\" type=\"button\" class=\"btn qp-button "+buttonStyle+"\" ondblclick=\"openDialogButtonAreaSetting(this)\" value=\""+item.labelText+"\">"+buttonContent+"</button>"+elementButton+"</span>";
		} else {
			elementTD += "<span "+style+"><button style=\""+ item.inputStyle + ' ' +item.style+";width:100%\" type=\"button\" class=\"btn qp-button "+buttonStyle+"\" ondblclick=\"openDialogButtonAreaSetting(this)\" value=\""+item.labelText+"\">"+item.labelText+"</button>"+elementButton+"</span>";
		}
	...
	if(dataType == 20){
		...
		var elementLabel =  "" 
			...
			elementLabel += "\",\"require\":\""+require+"\",\"elementtype\":\"0\"'>";
		elementTD += "<span><label style=\"cursor: pointer;"+ item.inputStyle + ' ' +item.style+"\" ondblclick=\"openDialogLableSetting(this, true)\">"+unescape(item.labelText)+"</label>"+elementLabel+"</span>";
	}	
	return elementTD;
}
...
function returnElementTDPreview(item, displayGroupType){	
	...
	if(dataType == 0){
		elementTD += "<span "+style+">" +
				"<div class=\"input-group\" style=\"width:100%\"><input style=\""+ item.inputStyle + ' '+item.style+"\" type=\"text\" ";
				if(item.elementtype == 0){
					elementTD += " class=\"form-control ui-autocomplete-input\" ";
				} else {
					elementTD += " class=\"qp-input-autocomplete\" ";
	...
	if(dataType == 1 || dataType == 15 || dataType == 16 || dataType == 18){
		...
		elementTD += "<span "+style+"><input style=\""+ item.inputStyle + ' '+item.style+"\" type=\""+dataTypeElement+"\" value=\""+item.defaultvalue+"\" ";
					if(item.elementtype == 0){
						elementTD += "class=\"form-control qp-input-text\"";
					} else {
						elementTD += "class=\"form-control qp-input-text\"";
	...
	if(dataType == 13){
		var elementButton =  "" 
			...
			if (item.icon != undefined && item.showLabel != undefined && item.icon.length > 0) {
				...
				elementTD += "<span "+style+"><button style=\""+ item.inputStyle + ' '+item.style+"\" type=\"button\" class=\"btn qp-button\" value=\""+item.labelText+"\">"+buttonContent+"</button>"+elementButton+"</span>";
			} else {
				elementTD += "<span "+style+"><button style=\""+ item.inputStyle + ' '+item.style+"\" type=\"button\" class=\"btn qp-button\" value=\""+item.labelText+"\">"+item.labelText+"</button>"+elementButton+"</span>";
			}
	}
	if(dataType == 20){
...
function returnElemenActionSection(item, styleArea){	
	...
	if(dataType == 0){
		elementTD += "<span "+style+" >" +
				"<div ondblclick=\"openDialogAutocompleteSettingSection(this)\" class=\"input-group\" style=\"width:100%\"><input style=\""+item.style+"\" type=\"text\" ";
				if(item.elementtype == 0){
					elementTD += " class=\"form-control ui-autocomplete-input\" ";
				} else {
					elementTD += " class=\"qp-input-autocomplete\" ";
	...
	if(dataType == 4){
		elementTD += "<span  "+style+" ><div class=\"input-group date\">"
		elementTD += "<span><input style=\""+item.style+"\" ondblclick=\"openDialogComponentSettingSection(this)\" type=\"text\" ";
						if(item.elementtype == 0){
							elementTD += "class=\"form-control\"";
						} else {
							elementTD += "class=\"form-control\"";
	...
	if(dataType == 5){
		if(item.msgvalue != undefined && item.msgvalue.length > 0){
			...
			$(msgValArr).each(function(j){
				...
				if(item.msglabel == undefined || item.msglabel.length == 0  || (msgLabelArr[j] == null || msgLabelArr[j] == 'null')){					
					elementTD += " name=\"" + item.columnname + "1\" /><label style=\""+item.style+"\" for=\""+item.columnname+"\">"+msgValArr[j]+"</label>";
				} else {					
					elementTD += " name=\"" + item.columnname + "1\" /><label style=\""+item.style+"\" for=\""+item.columnname+"\">"+msgLabelArr[j]+"</label>";
				}
			});
			elementTD += ""+element+"</span>";
		} else {
	...
	if(dataType == 13){
		var elementButton =  "" 
			...
			if (item.icon != undefined && item.showLabel != undefined && item.icon.length > 0) {
				...
				elementTD += "<span "+style+"><button style=\""+item.style+";width:100%\" type=\"button\" class=\"btn qp-button "+buttonStyle+"\" ondblclick=\"openDialogButtonAreaSettingSection(this)\" value=\""+item.labelText+"\">"+buttonContent+"</button>"+elementButton+"</span>";
			} else {
				elementTD += "<span "+style+"><button style=\""+item.style+";width:100%\" type=\"button\" class=\"btn qp-button "+buttonStyle+"\" ondblclick=\"openDialogButtonAreaSettingSection(this)\" value=\""+item.labelText+"\">"+item.labelText+"</button>"+elementButton+"</span>";
			}
	}
	if(dataType == 20){
		
		elementTD += "<span  "+style+" ><label style=\""+item.style+"\" ondblclick=\"openDialogLableSettingSection(this)\" style=\"cursor: pointer;\">"+item.labelText;
		var required="";
		if(item.mandatory == "true"){
...
function returnElement(div){	
	...
	if(dataType == 24){
		...
		elementLabel += "\",\"require\":\""+require+"\",\"elementtype\":\"0\"'>";
		elementTD += "<span><label ondblclick=\"openDialogCustomSetting(this, true)\" style=\"cursor: pointer;\">"+$(div).attr('label')+"</label>"+elementLabel+"</span>";
	}	
	...
	if(dataType == 13){
		...
		elementTD += "<span style=\"width: 100%;\"><button type=\"button\" class=\"btn qp-button\" ondblclick=\"openDialogButtonAreaSetting(this)\" value=\""+$(div).attr('labelText')+"\">"+$(div).attr('labelText')+"</button>"+elementButton+"</span>";
	}
	if(dataType == 20){
		var elementLabel =  "" 
			+ "<input type=\"hidden\" name=\"formElement\" "
...
function returnElementSearch(div){
		...
		if(dataType == 11){	
			...
			var elementButton =  "" 
				...
				elementButton += "\",\"require\":\""+require+"\",\"elementtype\":\"0\"'>";
			elementTD += "<span><a ondblclick=\"openDialogLinkAreaSetting(this,"+$(div)+");\" href=\"javascript:\">"+$(div).attr('labelText')+"</a>"+elementButton+"</span>";
		}
...
function returnElementTDSearchEntity(item, displayGroupType){
	...
	var dataType = item.datatype;
		...
		if(dataType == 0){
			elementTD += "<span "+style+">" +
					"<div ondblclick=\"openDialogAutocompleteSetting(this)\" class=\"input-group\" style=\"width:100%\"><input style=\""+ item.inputStyle + ' '+item.style+"\" type=\"text\" ";
					if(item.elementtype == 0){
						elementTD += " class=\"form-control ui-autocomplete-input\" ";
					} else {
						elementTD += " class=\"qp-input-autocomplete\" ";
		...
		if(dataType == 2){
			elementTD += "<span "+style+"><div  ondblclick=\"openDialogComponentSetting(this)\" style=\"width: 100%;\">" +
					"<input style=\""+ item.inputStyle + ' '+item.style+"\" type=\"text\" ";
						if(item.elementtype == 0){
							elementTD += "class=\"form-control qp-input-from pull-left\"";
						} else {
							elementTD += "class=\"com-input-integer-detail\"";
						...
						+ item.maxlength + "\" />" +
						"" + "<div class=\"qp-separator-from-to\">~</div>" +
						"<input style=\""+ item.inputStyle + ' '+item.style+"\" ondblclick=\"openDialogComponentSetting(this)\" type=\"text\" ";
						if(item.elementtype == 0){
							elementTD += "class=\"form-control qp-input-to pull-right\"";
						} else {
							elementTD += "class=\"com-input-integer-detail\"";
		...
		if(dataType == 4){
			...
			"<div class=\"input-group date qp-input-from pull-left\">";
			elementTD += "<input style=\""+ item.inputStyle + ' '+item.style+"\" type=\"text\" class=\"form-control qp-input-from\"";
			elementTD += " name=\"" 
							+ item.columnname + "1\" maxlength=\"" 
							+ item.maxlength + "\" />";
			elementTD += "<span class=\"input-group-addon\">"
			...
			+ "<div class=\"qp-separator-from-to\">~</div>" +
			"<div class=\"input-group date qp-input-to pull-right\">";
			elementTD += "<input style=\""+ item.inputStyle + ' '+item.style+"\" type=\"text\" ";
							if(item.elementtype == 0){
								elementTD += "class=\"form-control\"";
							} else {
								elementTD += "class=\"form-control \"";
		...
		if(dataType == 13){
			...
			if (item.icon != undefined && item.showLabel != undefined && item.icon.length > 0) {
				...
				elementTD += "<span "+style+"><button style=\""+ item.inputStyle + ' '+item.style+"\" type=\"button\" class=\"btn qp-button "+buttonStyle+"\" ondblclick=\"openDialogButtonAreaSetting(this)\" value=\""+item.labelText+"\">"+buttonContent+"</button>"+elementButton+"</span>";
			} else {
				elementTD += "<span "+style+"><button style=\""+ item.inputStyle + ' '+item.style+"\" type=\"button\" class=\"btn qp-button "+buttonStyle+"\" ondblclick=\"openDialogButtonAreaSetting(this)\" value=\""+item.labelText+"\">"+item.labelText+"</button>"+elementButton+"</span>";
			}
		}
		if(dataType == 20){
			if (item.labelText == undefined || item.labelText == null) {
...
function returnElementTDSearchEntityPreview(item, displayGroupType){
	...
	var dataType = item.datatype;
		...
		if(dataType == 0){
			elementTD += "<span "+style+">" +
					"<div class=\"input-group\" style=\"width:100%\"><input style=\""+item.style+"\" type=\"text\" ";
					if(item.elementtype == 0){
						elementTD += " class=\"form-control ui-autocomplete-input\" ";
					} else {
						elementTD += " class=\"qp-input-autocomplete\" ";
		...
		if(dataType == 1 || dataType == 15 || dataType == 16 || dataType == 18){
			...
			elementTD += "<span "+style+"><input style=\""+item.style+"\" type=\""+dataTypeElement+"\" ";
						if(item.elementtype == 0){
							elementTD += "class=\"form-control qp-input-text\"";
						} else {
							elementTD += "class=\"form-control qp-input-text-detail\"";
		...
		if(dataType == 2){
			elementTD += "<span "+style+"><div  style=\"width: 100%;\">" +
					"<input style=\""+item.style+"\" type=\"text\" ";
						if(item.elementtype == 0){
							elementTD += "class=\"form-control qp-input-from pull-left\"";
						} else {
							elementTD += "class=\"com-input-integer-detail\"";
		...
		if(dataType == 8){
			elementTD += "<span "+style+"><input style=\""+item.style+"\" type=\"text\" ";
						if(item.elementtype == 0){
							elementTD += "class=\"form-control\"";
						} else {
							elementTD += "class=\"com-input-currency-detail\"";
		...
		if(dataType == 4){
			...
			elementTD += "<input style=\""+item.style+"\" type=\"text\" ";
							if(item.elementtype == 0){
								elementTD += "class=\"form-control\"";
							} else {
								elementTD += "class=\"form-control \"";
		...
		if(dataType == 7){
			elementTD += "<span "+style+"><select style=\""+item.style+"\" name=\""+item.columnname+"\" ";
			if(item.elementtype == 0){
				elementTD += "class=\"form-control qp-input-select\"";
			} else {
				elementTD += "class=\"form-control qp-input-select-detail\"";
		...
		if(dataType == 10){
			elementTD += "<span "+style+"><textarea style=\""+item.style+"\" ";
						if(item.elementtype == 0){
							elementTD += "class=\"form-control qp-input-textarea\"";
						} else {
							elementTD += "class=\"form-control qp-input-textarea-detail\"";
		...
		if(dataType == 11){	
			...
			var elementButton =  "" 
				...
				elementButton += "\",\"require\":\""+require+"\",\"elementtype\":\"0\"'>";
			elementTD += "<span "+style+"><a style=\""+item.style+"\" onmouseover=\"this.setAttribute('style', '"+item.hoverStyle+"')\" onmouseout=\"this.setAttribute('style', '"+item.style+"')\" href=\"javascript:\">"+item.labelText+"</a>"+elementButton+"</span>";
		}
		...
		if(dataType == 13){
			...
			if (item.icon != undefined && item.showLabel != undefined && item.icon.length > 0) {
				...
				elementTD += "<span "+style+"><button style=\""+item.style+"\" type=\"button\" class=\"btn qp-button\" value=\""+item.labelText+"\">"+buttonContent+"</button>"+elementButton+"</span>";
			} else {
				elementTD += "<span "+style+"><button style=\""+item.style+"\" type=\"button\" class=\"btn qp-button\" value=\""+item.labelText+"\">"+item.labelText+"</button>"+elementButton+"</span>";
			}
		}
		if(dataType == 20){
			elementTD += "<label style=\"cursor: pointer;"+item.style+"\">"+item.labelText+"</label>";
		}
...
function mergeTable(obj, data, rowspan, colspan) {
	...
	if ((rowspan > 1 || colspan > 1) && (data.rowspan != rowspan || data.colspan != colspan)) {
		if (!confirm(dbMsgSource['sc.screendesign.0413'])) {
			return false;
		}
	}
...
function saveOutputSetting($modal, data, obj) {
	...
	if (isExists) {
		alert(dbMsgSource['sc.screendesign.0285']);
		return false;
	}
	...
	if (levelParent != '' && levelParent != currentLevelParent) {
		alert(dbMsgSource['sc.screendesign.0286']);
		return false;
	}
...
function loadParameter(obj, defaultParameters, target) {
	...
	if (actionType == 0) {
		...
		var parameters = $.qp.getString(CONTEXT_PATH + '/screendesign/getScreenParams?screenId=' + value);
				...
				$(arrParameters).each(function(i) {
					if (arrParameters[i] != null && arrParameters[i].length > 0) {
						...
						if (paramElement != undefined && paramElement != null && paramElement.length > 0) {
							$(table).find("#dialog-form-parameter-tbl-parameter").find("tbody").find('input[name=parameterAttribute][value="'+param[0]+'"]').closest('tr').find('input[name=screenItemCodeAutocomplete]').val(getCode(param[1]));
							$(table).find("#dialog-form-parameter-tbl-parameter").find("tbody").find('input[name=parameterAttribute][value="'+param[0]+'"]').closest('tr').find('input[name=screenItemCode]').val(param[1]);
						}
					}
				});
			}
		...
		var dataString = "";
		try{
			dataString = $.qp.getString(CONTEXT_PATH + '/screendesign/getBusinessDesign?businesslogicid=' + value);
			...
			if (inputBeans != undefined && inputBeans != null) {
				...
				for (var i = 0; i < inputBeans.length; i++) {
					...
					if (parentBeanId == null) {
						$(table).find('.mapping-bean').find('tbody tr:eq('+i+')').find('input[name=screenItemCodeAutocomplete]').attr('arg03', inputBeans[i].arrayFlg);
					} else {
						$(table).find('.mapping-bean').find('tbody tr:eq('+i+')').find('input[name=screenItemCodeAutocomplete]').attr('arg03', parentIsArray);
					}
	...
	switch(data.datatype) {
		...
		case '6':
			...
			$(result['obj']).children().each(function() {
				if ($(this).attr('name') == undefined || $(this).attr('name') != 'formElement') {
					$(this).remove();
				}
			});
			break;
...
function AddActionListComponent(btn) {
	...
	if (actionType == 0) {
		alert(dbMsgSource['sc.screendesign.0323']);
	...
	if (actionType == 1) {
		...
		if ($(parent).find('#listEvent').find(".onsubmit-event").length > 0) {
			alert(dbMsgSource['sc.screendesign.0324']);
			return;
		}
...
function checkEffectAreaType(obj) {
	...
	if (checked == undefined || checked == null || checked.length == 0) {
		alert(dbMsgSource['sc.screendesign.0287']);
...
function validateBLogicNameEventSetting(blogic) {
	...
	if ($(blogic).find('input[name=businessLoginAutocomplete]').val() == undefined || $(blogic).find('input[name=businessLoginAutocomplete]').val().length == 0) {
		alert(dbMsgSource['sc.screendesign.0288']);
...
function validateEffectAreaEventSetting(blogic) {
	...
	if ($(blogic).find('input[name=effectArea]').val() == undefined || $(blogic).find('input[name=effectArea]').val().length == 0) {
		alert(dbMsgSource['sc.screendesign.0289']);
...
function checkExistsItem(event) {
	var target = event.target;
	
	var parent = $(event.target).closest('tr[name=if], tr[name=then]');
	...
	if (!isValid) {
		alert(dbMsgSource['sc.screendesign.0290']);
		$(target).focus();
		return;
	}
}
...
function displayParamAction(modal, data) {
	if (data.actiontype != undefined && data.actiontype.length > 0 && data.actiontype != 'undefined') {
		...
		if (data.actiontype == 0) {
			...
			loadParameter($(modal).find("#navigateToScreen").find("input[name='navigateTo']"));
		} else if (data.actiontype == 1) {
			...
			loadParameter($(modal).find("#navigateToblogic").find("input[name='navigateTo']"));
		}
...
function saveStyle(modal, data, obj) {
	...
	if (margiRight != undefined && margiRight != null && margiRight.length > 0) {
		style += "margi-right:" + margiRight + "px;"; 
	}
	...
	if ($(obj).next().prop('name') == 'formElement') {
		...
		if (data.datatype == 11 && hoverStyle != null && hoverStyle.length > 0) {
...
function saveAreaStyle(modal, obj) {
	...
	if (panelStyle != null && panelStyle != "") {
		if(areaType == 4) {
			panelSectionStyle += panelStyle;
			$(obj).closest('.areaContent').find('.panel-heading').attr('style', panelSectionStyle);
		} else {
	...
	if (headerStyle != null && headerStyle.length > 0) {
		$(obj).closest('.areaContent').find('.table tbody th, .table thead th').attr('style', headerStyle);
		
		$(obj).closest('.areaContent').find('.table tbody th, .table thead th').find('label').each(function() {
			var oldStyle = $(this).attr('style');
			
			if (oldStyle != undefined) {
				$(this).attr('style', oldStyle + headerStyle);
			} else {
	...
	if (rowStyle != null) {
		...
		$(obj).closest('.areaContent').find('.table tbody tr').find('label').each(function() {
			var oldStyle = $(this).attr('style');
			
			if (oldStyle != undefined) {
				$(this).attr('style', oldStyle + rowStyle);
			} else {
	...
	if (inputStyle != null) {
		$(obj).closest('.areaContent').find('.table tbody tr td').attr('style', inputStyle);
		
		$(obj).closest('.areaContent').find('.table tbody tr td').find('input, textarea, label').each(function() {
			var oldStyle = $(this).attr('style');
			
			if (oldStyle != undefined) {
				$(this).attr('style', oldStyle + inputStyle);
			} else {
...
function reloadStyle(table) {
	...
	if (inputStyle != undefined && inputStyle != null && inputStyle.length > 0)
		$(table).find('tbody tr td').attr('style', inputStyle);
	
	if (rowStyle != undefined && rowStyle != null && rowStyle.length > 0)
		$(table).find('tbody tr').attr('style', rowStyle);
	
	if (headerStyle != undefined && headerStyle != null && headerStyle.length > 0)
		$(table).find('tbody th,thead th').attr('style', headerStyle);
}
