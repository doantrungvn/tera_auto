...
public class QpTimeNotEqualValidator implements ConstraintValidator<QpTimeNotEqual, String> {
	...
	@Override
	public void initialize(QpTimeNotEqual constraintAnnotation) {
	...
	public boolean isValid(String value, ConstraintValidatorContext context) {
		if(StringUtils.isEmpty(this.patternFomrat)){
			return false;
		}
		validation = new ValidationCompareDate(equalValue, this.patternFomrat);
		return this.validation.isValid(value,DateTimeType.TIME,TypesValidateDateTime.NOT_EQUAL);
	}
