...
public class QpTimestampEqualValidator  implements ConstraintValidator<QpTimestampEqual, String> {
	...
	@Override
	public void initialize(QpTimestampEqual constraintAnnotation) {
