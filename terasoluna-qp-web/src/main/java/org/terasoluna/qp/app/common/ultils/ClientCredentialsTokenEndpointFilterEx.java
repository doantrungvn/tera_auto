 ...
 * 
 */
public class ClientCredentialsTokenEndpointFilterEx extends AbstractAuthenticationProcessingFilter {
	...
	public ClientCredentialsTokenEndpointFilterEx() {
		this("/oauth/token");
	}

	public ClientCredentialsTokenEndpointFilterEx(String path) {
		super(path);
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
	    ...
	    extraParams.put("username", new String[] {FunctionCommon.getOauth2Username()});
	    extraParams.put("password", new String[] {FunctionCommon.getOauth2Password()});
	    HttpServletRequest wrappedRequest = new WrappedRequestWithParameter(request, extraParams);
	    
		super.successfulAuthentication(wrappedRequest, response, chain, authResult);
	...
	//add WrappedRequestWithParameter class 
	class WrappedRequestWithParameter extends HttpServletRequestWrapper
	{
	     ...
	     */
	    public WrappedRequestWithParameter(final HttpServletRequest request, 
