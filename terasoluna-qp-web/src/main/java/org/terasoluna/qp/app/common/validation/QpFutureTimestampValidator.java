...
public class QpFutureTimestampValidator implements ConstraintValidator<QpFutureTimestamp, String>{
	
	private ValidationCompareDate validate;
	
	private String patternFomrat;
	
	public void initialize(QpFutureTimestamp constraintAnnotation) {
