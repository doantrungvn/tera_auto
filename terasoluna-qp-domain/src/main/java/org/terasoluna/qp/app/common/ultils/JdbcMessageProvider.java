...
public class JdbcMessageProvider implements MessageProvider, MessageAcceptor {
    ...
    private String languageColumn = "language_code";
    private String countryColumn = "country_code";
    private String variantColumn = "remark";
    private String keyColumn = "message_code";
    private String messageColumn = "message_string";
    ...
    public Messages getMessages(String basename) {
        ...
        String query =
                String.format(getSelectMessagesQuery(), addDelimiter(languageColumn), addDelimiter(countryColumn),
                        ...
                        addDelimiter(tableName), addDelimiter(languageColumn), addDelimiter(countryColumn));
    ...
    public void setMessages(String basename, Messages messages) {
        ...
        String query =
                String.format(getInsertMessageQuery(), addDelimiter(tableName),
