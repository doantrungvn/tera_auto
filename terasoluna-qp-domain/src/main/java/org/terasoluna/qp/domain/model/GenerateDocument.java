...
public class GenerateDocument implements Serializable {
	...
	/**
	 * @param generateDocumentProjectTypeRDLst
	 *            the generateDocumentProjectTypeRDLst to set
	 */
	public void setGenerateDocumentProjectTypeRDLst(List<GenerateDocumentItem> generateDocumentProjectTypeRDLst) {
	...
	/**
	 * @param generateDocumentProjectTypeEDLst
	 *            the generateDocumentProjectTypeEDLst to set
	 */
	public void setGenerateDocumentProjectTypeEDLst(List<GenerateDocumentItem> generateDocumentProjectTypeEDLst) {
	...
	/**
	 * @param generateDocumentItemLst
	 *            the generateDocumentItemLst to set
	 */
	...
	/**
	 * @param generateDocumentModuleTypeEDLst
	 *            the generateDocumentModuleTypeEDLst to set
	 */
	public void setGenerateDocumentModuleTypeEDLst(List<GenerateDocumentItem> generateDocumentModuleTypeEDLst) {
	...
	/**
	 * @param generateDocumentItem
	 *            the generateDocumentItem to set
	 */
