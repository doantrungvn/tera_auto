package org.terasoluna.qp.domain.repository.viewdesign;

import java.io.Serializable;

public class ViewDesignSearchCriteria implements Serializable {
	...
	public String getViewDesignName() {
		return sqlDesignName;
	}
	public void setViewDesignName(String sqlDesignName) {
		this.sqlDesignName = sqlDesignName;
	}
	public String getViewDesignCode() {
		return sqlDesignCode;
	}
	public void setViewDesignCode(String sqlDesignCode) {
	...
	public Integer[] getViewDesignTypes() {
		return sqlDesignTypes;
	}
	public void setViewDesignTypes(Integer[] sqlDesignTypes) {
