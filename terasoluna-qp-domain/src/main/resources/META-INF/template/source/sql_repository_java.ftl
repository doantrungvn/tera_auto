...
package ${projectCode?lower_case}.domain.repository.${moduleCode?lower_case};

import ${projectCode?lower_case}.domain.model.${moduleCode?lower_case}.*;
<#else>
package ${projectCode?lower_case}.domain.repository.common;
...
<#list sqlDesignCompounds as sqlDesignCompound>
	...
	*/
	public List<org.terasoluna.qp.domain.model.Autocomplete> QP_ATC_${sqlDesignCompound.sqlDesign.autoCompleteId}(${sqlDesignCompound.sqlDesign.sqlDesignCode?cap_first}InputBean input); -->		
			<#else>
