...
<#if singleObjList?size gt 0>
	<#list singleObjList as item>
		<#switch item.dataType>
			<#case 0 >
<#if businessLogic.blogicType == 0>
import ${package}.domain.service.${module.moduleCode?lower_case }.${businessLogic.businessLogicCode?lower_case}objectdefinition.${item.objectDefinitionCode?cap_first};
</#if>
<#if businessLogic.blogicType == 2>
import ${package}.domain.service.${module.moduleCode?lower_case }.${businessLogic.businessLogicCode?lower_case}objectdefinition.${item.objectDefinitionCode?cap_first};
</#if>
<#if businessLogic.blogicType == 1>
import ${package}.domain.service.common.${businessLogic.businessLogicCode?lower_case}objectdefinition.${item.objectDefinitionCode?cap_first};
</#if>
				<#break>
		</#switch>
	</#list>
