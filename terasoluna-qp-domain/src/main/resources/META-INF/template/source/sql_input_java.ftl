...
<#list sqlDesignCompound.sqlDesignInputs as sqlDesignInput>
	...
	<#elseif sqlDesignInput.dataType == 0 && !(sqlDesignInput.sqlDesignInputParentId?has_content)>
    	<#if sqlDesignInput.designType == 0>
    		<#if !moduleCode?? || moduleCode == ''>
    			<#assign object_path = "${projectCode?lower_case}.domain.model.common.${sqlDesignCompound.sqlDesign.sqlDesignCode?uncap_first}InputBean">
			<#else>
				<#assign object_path = "${projectCode?lower_case}.domain.model.${moduleCode?lower_case}.${sqlDesignCompound.sqlDesign.sqlDesignCode?uncap_first}InputBean">
			</#if>
    	<#else>
    		<#if !moduleCode?? || moduleCode == ''>
	...
	private java.util.List<${sqlDesignInput.packageName}.ConditionModel> conditions;
			<#else>
	private java.util.List<${projectCode?lower_case}.domain.model.<#if (sqlDesignInput.objectTypeCode)??>${sqlDesignInput.objectTypeCode?cap_first}</#if><#if !(sqlDesignInput.objectTypeCode)??>${sqlDesignInput.sqlDesignInputName?capitalize?replace("","")}</#if>> ${sqlDesignInput.sqlDesignInputCode?uncap_first};				
			</#if>
		<#else>
	private ${projectCode?lower_case}.domain.model.<#if (sqlDesignInput.objectTypeCode)??>${sqlDesignInput.objectTypeCode?cap_first}</#if><#if !(sqlDesignInput.objectTypeCode)??>${sqlDesignInput.sqlDesignInputName?capitalize?replace("","")}</#if> ${sqlDesignInput.sqlDesignInputCode?uncap_first};	
		</#if>
	<#elseif sqlDesignInput.dataType == 16 && !(sqlDesignInput.sqlDesignInputParentId?has_content)>
		<#if sqlDesignInput.arrayFlag==1>
	private java.util.List<${projectCode?lower_case}.domain.commonobject.<#if (sqlDesignInput.moduleCode)??>${sqlDesignInput.moduleCode?lower_case}.</#if><#if (sqlDesignInput.objectTypeCode)??>${sqlDesignInput.objectTypeCode?cap_first}</#if><#if !(sqlDesignInput.objectTypeCode)??>${sqlDesignInput.sqlDesignInputName?capitalize?replace("","")}</#if>> ${sqlDesignInput.sqlDesignInputCode?uncap_first};	
		<#else>
...
<#list sqlDesignCompound.sqlDesignInputs as sqlDesignInput>	
     ...
     * @return ${sqlDesignInput.sqlDesignInputName!""}
     */
	public java.util.List<${projectCode?lower_case}.domain.model.<#if (sqlDesignInput.objectTypeCode)??>${sqlDesignInput.objectTypeCode?cap_first}</#if><#if !(sqlDesignInput.objectTypeCode)??>${sqlDesignInput.sqlDesignInputName?capitalize?replace("","")}</#if>> get${sqlDesignInput.sqlDesignInputCode?cap_first}(){
		return this.${sqlDesignInput.sqlDesignInputCode?uncap_first};
	}
     ...
     * @return ${sqlDesignInput.sqlDesignInputName!""}
     */
	public ${projectCode?lower_case}.domain.model.<#if (sqlDesignInput.objectTypeCode)??>${sqlDesignInput.objectTypeCode?cap_first}</#if><#if !(sqlDesignInput.objectTypeCode)??>${sqlDesignInput.sqlDesignInputName?capitalize?replace("","")}</#if> get${sqlDesignInput.sqlDesignInputCode?cap_first}(){
		return this.${sqlDesignInput.sqlDesignInputCode?uncap_first};
	}
     ...
     * @param ${sqlDesignInput.sqlDesignInputName!""}
     */
	public void set${sqlDesignInput.sqlDesignInputCode?cap_first}(${projectCode?lower_case}.domain.model.<#if (sqlDesignInput.objectTypeCode)??>${sqlDesignInput.objectTypeCode?cap_first}</#if><#if !(sqlDesignInput.objectTypeCode)??>${sqlDesignInput.sqlDesignInputName?capitalize?replace("","")}</#if> ${sqlDesignInput.sqlDesignInputCode?uncap_first}){
		this.${sqlDesignInput.sqlDesignInputCode?uncap_first} = ${sqlDesignInput.sqlDesignInputCode?uncap_first};
	}
		</#if>
	<#elseif sqlDesignInput.dataType == 16 && !(sqlDesignInput.sqlDesignInputParentId?has_content)>
     ...
     * @param ${sqlDesignInput.sqlDesignInputName!""}
     */
	public void set${sqlDesignInput.sqlDesignInputCode?cap_first}(${projectCode?lower_case}.domain.commonobject.<#if (sqlDesignInput.moduleCode)??>${sqlDesignInput.moduleCode?lower_case}.</#if><#if (sqlDesignInput.objectTypeCode)??>${sqlDesignInput.objectTypeCode?cap_first}</#if><#if !(sqlDesignInput.objectTypeCode)??>${sqlDesignInput.sqlDesignInputName?capitalize?replace("","")}</#if> ${sqlDesignInput.sqlDesignInputCode?uncap_first}){
		this.${sqlDesignInput.sqlDesignInputCode?uncap_first} = ${sqlDesignInput.sqlDesignInputCode?uncap_first};
	}
		</#if>	
	<#elseif sqlDesignInput.dataType == 17 && !(sqlDesignInput.sqlDesignInputParentId?has_content)>
