...
<#if moduleCode!=''>
<mapper namespace="${projectCode?lower_case}.domain.repository.${moduleCode?lower_case}.${moduleCode?cap_first}Repository">
<#else>
<mapper namespace="${projectCode?lower_case}.domain.repository.common.CommonRepository">
</#if>
<#list sqlDesignCompounds as sqlDesignCompound>
	...
	<resultMap id="${sqlDesignCompound.sqlDesign.sqlDesignCode?uncap_first + 'ResultMap'}" type="org.terasoluna.qp.domain.model.Autocomplete">
			<#else>
				<#if moduleCode?has_content>
	<resultMap id="${sqlDesignCompound.sqlDesign.sqlDesignCode?uncap_first + 'ResultMap'}" type="${projectCode?lower_case}.domain.model.${moduleCode?lower_case}.${sqlDesignCompound.sqlDesign.sqlDesignCode?cap_first + "OutputBean"}">
				<#else>
	<resultMap id="${sqlDesignCompound.sqlDesign.sqlDesignCode?uncap_first + 'ResultMap'}" type="${projectCode?lower_case}.domain.model.common.${sqlDesignCompound.sqlDesign.sqlDesignCode?cap_first + "OutputBean"}">
				</#if>
			</#if>
