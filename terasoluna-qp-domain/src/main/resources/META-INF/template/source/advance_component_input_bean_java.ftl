/*
 * @(#)${methodName?cap_first }${blogic.businessLogicCode?cap_first }Input.java
 * 
 ...
 * @version $Revision$
 */
public class ${methodName?cap_first }${blogic.businessLogicCode?cap_first }Input implements Serializable {
