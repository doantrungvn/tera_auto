/*
 * @(#)${businessLogic.businessLogicCode?cap_first }InputBean.java
 * 
...
<#list singleInputList as item>
	<#switch item.dataType>
		<#case 0 >
			<#if businessLogic.blogicType == 0 || businessLogic.blogicType == 2>
import ${package}.domain.service.${module.moduleCode?lower_case }.${businessLogic.businessLogicCode?lower_case }inputbean.${item.inputBeanCode?cap_first };
			</#if>
			<#if businessLogic.blogicType == 1>
				<#if businessLogic.customizeFlg>
import ${package}.domain.service.commoncustomize.${businessLogic.businessLogicCode?lower_case }inputbean.${item.inputBeanCode?cap_first };
				<#else>
import ${package}.domain.service.common.${businessLogic.businessLogicCode?lower_case }inputbean.${item.inputBeanCode?cap_first };
				</#if>
			</#if>
			<#break>
	</#switch>
 ...
 * @version $Revision$
 */
public class ${businessLogic.businessLogicCode?cap_first }InputBean implements Serializable {
