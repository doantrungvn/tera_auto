/*
 * @(#)${businessLogic.businessLogicCode?cap_first }OutputBean.java
 * 
...
<#if businessLogic.blogicType == 1>
	<#if businessLogic.customizeFlg>
import ${package}.batch.service.commoncustomize.${businessLogic.businessLogicCode?lower_case }outputbean.${item.outputBeanCode?cap_first };
	<#else>
import ${package}.batch.service.common.${businessLogic.businessLogicCode?lower_case }outputbean.${item.outputBeanCode?cap_first };
	</#if>
</#if>
				<#break>
		</#switch>
 ...
 * @version $Revision$
 */
public class ${businessLogic.businessLogicCode?cap_first }OutputBean implements Serializable {
