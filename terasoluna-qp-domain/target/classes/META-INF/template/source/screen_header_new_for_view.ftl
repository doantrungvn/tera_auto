...
@media (max-width: 767px) {
	...
	function showConfirmForGenerateHTML(url,obj) {
		...
		$("#fcomConfirmBtnYes").on("click", function(e) {
            ...
            <#if destinationTemplateType?has_content && destinationTemplateType?string == "popup">
            	location.href =url;
            </#if>
             <#if destinationTemplateType?has_content && destinationTemplateType?string == "normal">
