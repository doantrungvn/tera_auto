...
package ${package}.batch.service.commoncustomize.${businessLogic.businessLogicCode?lower_case }objectdefinition;
	<#else>
package ${package}.batch.service.common.${businessLogic.businessLogicCode?lower_case }objectdefinition;
	</#if>
</#if>
