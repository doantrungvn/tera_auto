...
package ${package}.domain.service.${module.moduleCode?lower_case }.${businessLogic.businessLogicCode?lower_case}inputbean;
</#if>
<#if businessLogic.blogicType == 1>
	<#if businessLogic.customizeFlg>
package ${package}.domain.service.commoncustomize.${businessLogic.businessLogicCode?lower_case}inputbean;
	<#else>
package ${package}.domain.service.common.${businessLogic.businessLogicCode?lower_case}inputbean;
	</#if>
</#if>
...
public class ${inputBean.inputBeanCode?cap_first } implements Serializable {
	...
	<#if inputBean.singleList?has_content && inputBean.singleList?size gt 0>
