...
package ${projectCode?lower_case}.domain.model.${moduleCode?lower_case}.${sqlDesign.sqlDesignCode?lower_case + "outputbean"};
<#else>
package ${projectCode?lower_case}.domain.model.common.${sqlDesign.sqlDesignCode?lower_case + "outputbean"};
</#if>
