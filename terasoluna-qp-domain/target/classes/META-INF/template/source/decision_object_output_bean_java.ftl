/*
 * @(#)${outputBean.decisionOutputBeanCode?cap_first }.java
 * 
 * Copyright (c) 2016 NTTDATA Corporation.
 */
package ${package}.${place}${moduleCode?lower_case }.${decision.decisionTbCode?lower_case }outputbean;
 ...
 * @version $Revision$
 */
public class ${outputBean.decisionOutputBeanCode?cap_first } implements Serializable {
