...
package ${package}.batch.service.commoncustomize.${businessLogic.businessLogicCode?lower_case }outputbean;
	<#else>
package ${package}.batch.service.common.${businessLogic.businessLogicCode?lower_case }outputbean;
	</#if>
</#if>
