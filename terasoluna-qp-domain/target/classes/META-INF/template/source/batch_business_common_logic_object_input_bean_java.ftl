...
package ${package}.batch.service.commoncustomize.${businessLogic.businessLogicCode?lower_case}inputbean;
	<#else>
package ${package}.batch.service.common.${businessLogic.businessLogicCode?lower_case}inputbean;
	</#if>
</#if>
