/*
 * @(#)${functionMethod.functionMethodCode?cap_first }OutputBean.java
 * 
...
<#list singleOutputList as item>
	<#switch item.dataType>
		<#case 0 >
import ${packageName?lower_case}.${functionMaster.functionMasterCode?lower_case}.${functionMethod.functionMethodCode?lower_case}.${functionMethod.functionMethodCode?lower_case}outputbean.${item.methodOutputCode?cap_first };
			<#break>
		<#case 16>
 ...
 * @version $Revision$
 */
public class ${functionMethod.functionMethodCode?cap_first }OutputBean implements Serializable {
