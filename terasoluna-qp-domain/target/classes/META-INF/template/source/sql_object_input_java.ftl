...
package ${projectCode?lower_case}.domain.model.${moduleCode?lower_case}.${sqlDesign.sqlDesignCode?lower_case + "inputbean"};
<#else>
package ${projectCode?lower_case}.domain.model.common.${sqlDesign.sqlDesignCode?lower_case + "inputbean"};
</#if>
 ...
 * ${sqlDesign.remark!""}
 *
 * @author ${sqlDesign.author!""}
 * @version $Revision$
 */
public class ${parentCode?cap_first} {
